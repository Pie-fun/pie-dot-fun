...
function createBaseStaking(): Staking {
  return { name: "", userAddress: "", currency: 0, amount: 0, state: 0 };
}
...
export const Staking = {
  ...
  fromJSON(object: any): Staking {
    return {
      ...
      currency: isSet(object.currency) ? stakingCurrencyFromJSON(object.currency) : 0,
      amount: isSet(object.amount) ? globalThis.Number(object.amount) : 0,
      state: isSet(object.state) ? stakingStateFromJSON(object.state) : 0,
    };
  },
