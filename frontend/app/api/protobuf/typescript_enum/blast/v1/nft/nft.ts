...
export const protobufPackage = "blast.v1.nft";
...
export const ListNFTsRequest = {
  encode(message: ListNFTsRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ListNFTsRequest {
...
export const ListNFTsResponse = {
  encode(message: ListNFTsResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ListNFTsResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListNFTsDelegateRequest = {
  encode(message: ListNFTsDelegateRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.ownerAddress !== "") {
      writer.uint32(10).string(message.ownerAddress);
    }
    return writer;
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ListNFTsDelegateRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListNFTsDelegateResponse = {
  encode(message: ListNFTsDelegateResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    for (const v of message.nfts) {
      NFT.encode(v!, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ListNFTsDelegateResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetNFTRequest = {
  encode(message: GetNFTRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.nft !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): GetNFTRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ValidateNFTAccessRequest = {
  encode(message: ValidateNFTAccessRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.nft !== "") {
      writer.uint32(10).string(message.nft);
    }
    if (message.ownerAddress !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ValidateNFTAccessRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ValidateNFTAccessResponse = {
  encode(message: ValidateNFTAccessResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.nft !== undefined) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ValidateNFTAccessResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListOwnersRequest = {
  encode(message: ListOwnersRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    for (const v of message.nfts) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ListOwnersRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListOwnersResponse = {
  encode(message: ListOwnersResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    Object.entries(message.owners).forEach(([key, value]) => {
      ListOwnersResponse_OwnersEntry.encode({ key: key as any, value }, writer.uint32(10).fork()).ldelim();
    });
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): ListOwnersResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListOwnersResponse_NFTs = {
  encode(message: ListOwnersResponse_NFTs, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    for (const v of message.nfts) {
      writer.uint32(10).string(v!);
    }
    return writer;
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ListOwnersResponse_NFTs {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListOwnersResponse_OwnersEntry = {
  encode(message: ListOwnersResponse_OwnersEntry, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
    if (message.value !== undefined) {
      ListOwnersResponse_NFTs.encode(message.value, writer.uint32(18).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): ListOwnersResponse_OwnersEntry {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ValidateNFTRequest = {
  encode(message: ValidateNFTRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.nft !== "") {
      writer.uint32(10).string(message.nft);
    }
    return writer;
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ValidateNFTRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ValidateNFTResponse = {
  encode(message: ValidateNFTResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ValidateNFTResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CheckHolderOfContractRequest = {
  encode(message: CheckHolderOfContractRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.nftContract !== "") {
      writer.uint32(10).string(message.nftContract);
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): CheckHolderOfContractRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CheckHolderOfContractResponse = {
  encode(message: CheckHolderOfContractResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): CheckHolderOfContractResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const NFT = {
  encode(message: NFT, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.contract !== undefined) {
      NFTContract.encode(message.contract, writer.uint32(90).fork()).ldelim();
    }
    return writer;
  },
...
function createBaseNFTContract(): NFTContract {
  return { name: "", address: "", displayName: "", symbol: "", chain: 0, type: 0, imageUri: "" };
}

export const NFTContract = {
  encode(message: NFTContract, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.name !== "") {
      writer.uint32(10).string(message.name);
    }
    if (message.address !== "") {
    ...
    if (message.chain !== 0) {
      writer.uint32(40).int32(message.chain);
    }
    if (message.type !== 0) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): NFTContract {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const NFTServiceServiceName = "blast.v1.nft.NFTService";
export class NFTServiceClientImpl implements NFTService {
  private readonly rpc: Rpc;
  private readonly service: string;
  constructor(rpc: Rpc, opts?: { service?: string }) {
    this.service = opts?.service || NFTServiceServiceName;
    this.rpc = rpc;
    this.GetNFT = this.GetNFT.bind(this);
    this.ListNFTs = this.ListNFTs.bind(this);
    this.ListOwners = this.ListOwners.bind(this);
    this.ValidateNFTAccess = this.ValidateNFTAccess.bind(this);
    this.ListNFTsDelegate = this.ListNFTsDelegate.bind(this);
    this.ValidateNFT = this.ValidateNFT.bind(this);
    this.GetContract = this.GetContract.bind(this);
    this.CheckHolderOfContract = this.CheckHolderOfContract.bind(this);
  }
  GetNFT(request: GetNFTRequest): Promise<NFT> {
    const data = GetNFTRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "GetNFT", data);
    return promise.then((data) => NFT.decode(_m0.Reader.create(data)));
  }

  ListNFTs(request: ListNFTsRequest): Promise<ListNFTsResponse> {
    const data = ListNFTsRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "ListNFTs", data);
    return promise.then((data) => ListNFTsResponse.decode(_m0.Reader.create(data)));
  }

  ListOwners(request: ListOwnersRequest): Promise<ListOwnersResponse> {
    const data = ListOwnersRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "ListOwners", data);
    return promise.then((data) => ListOwnersResponse.decode(_m0.Reader.create(data)));
  }

  ValidateNFTAccess(request: ValidateNFTAccessRequest): Promise<ValidateNFTAccessResponse> {
    const data = ValidateNFTAccessRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "ValidateNFTAccess", data);
    return promise.then((data) => ValidateNFTAccessResponse.decode(_m0.Reader.create(data)));
  }

  ListNFTsDelegate(request: ListNFTsDelegateRequest): Promise<ListNFTsResponse> {
    const data = ListNFTsDelegateRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "ListNFTsDelegate", data);
    return promise.then((data) => ListNFTsResponse.decode(_m0.Reader.create(data)));
  }

  ValidateNFT(request: ValidateNFTRequest): Promise<ValidateNFTResponse> {
    const data = ValidateNFTRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "ValidateNFT", data);
    return promise.then((data) => ValidateNFTResponse.decode(_m0.Reader.create(data)));
  }

  GetContract(request: GetContractRequest): Promise<NFTContract> {
    const data = GetContractRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "GetContract", data);
    return promise.then((data) => NFTContract.decode(_m0.Reader.create(data)));
  }

  CheckHolderOfContract(request: CheckHolderOfContractRequest): Promise<CheckHolderOfContractResponse> {
    const data = CheckHolderOfContractRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "CheckHolderOfContract", data);
    return promise.then((data) => CheckHolderOfContractResponse.decode(_m0.Reader.create(data)));
  }
}
