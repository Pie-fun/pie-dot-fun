...
function createBaseSpaceship(): Spaceship {
  return { name: "", address: "", ownerAddress: "", type: 0, createTime: undefined, nft: undefined };
}
...
export const Spaceship = {
  encode(message: Spaceship, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.nft !== undefined) {
      SpaceshipNFT.encode(message.nft, writer.uint32(50).fork()).ldelim();
    }
    return writer;
  },
...
export const SpaceshipServiceServiceName = "blast.v1.spaceship.SpaceshipService";
