...
export const ListPointsAggregateRequest = {
  encode(message: ListPointsAggregateRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ListPointsAggregateRequest {
...
export const ListPointsAggregateResponse = {
  encode(message: ListPointsAggregateResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    for (const v of message.pointsAggregate) {
      PointsAggregate.encode(v!, writer.uint32(10).fork()).ldelim();
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ListPointsAggregateResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const PointsAggregate = {
  encode(message: PointsAggregate, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.name !== "") {
    ...
    if (message.referral !== undefined) {
      Referral.encode(message.referral, writer.uint32(42).fork()).ldelim();
    }
    if (message.staking !== undefined) {
      Staking.encode(message.staking, writer.uint32(50).fork()).ldelim();
    }
    if (message.activity !== undefined) {
      Activity.encode(message.activity, writer.uint32(58).fork()).ldelim();
    }
    if (message.bonus !== undefined) {
      Bonus.encode(message.bonus, writer.uint32(66).fork()).ldelim();
    }
    for (const v of message.multipliers) {
      Multiplier.encode(v!, writer.uint32(74).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): PointsAggregate {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListSquareMemberRankingsAggregateRequest = {
  encode(message: ListSquareMemberRankingsAggregateRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.square !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ListSquareMemberRankingsAggregateRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListSquareMemberRankingsAggregateResponse = {
  encode(message: ListSquareMemberRankingsAggregateResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    for (const v of message.rankingsAggregate) {
      SquareMemberRankingAggregate.encode(v!, writer.uint32(10).fork()).ldelim();
    }
    if (message.nextPageToken !== "") {
      writer.uint32(18).string(message.nextPageToken);
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ListSquareMemberRankingsAggregateResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SquareMemberRankingAggregate = {
  encode(message: SquareMemberRankingAggregate, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.rank !== 0) {
    ...
    if (message.member !== undefined) {
      SquareMemberAggregate.encode(message.member, writer.uint32(26).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): SquareMemberRankingAggregate {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
function createBaseSquareMemberAggregate(): SquareMemberAggregate {
  return { name: "", squareTokenId: "", user: undefined, type: 0, totalPoints: 0, joinTime: undefined };
}

export const SquareMemberAggregate = {
  encode(message: SquareMemberAggregate, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.name !== "") {
      writer.uint32(10).string(message.name);
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): SquareMemberAggregate {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetSquareAggregateRequest = {
  encode(message: GetSquareAggregateRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.square !== "") {
      writer.uint32(10).string(message.square);
    }
    if (message.view !== 0) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): GetSquareAggregateRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SquareAggregate = {
  encode(message: SquareAggregate, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.name !== "") {
      writer.uint32(10).string(message.name);
    }
    if (message.tokenId !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): SquareAggregate {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListSquaresAggregateRequest = {
  encode(message: ListSquaresAggregateRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.pageSize !== 0) {
      writer.uint32(8).int32(message.pageSize);
    }
    if (message.pageToken !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ListSquaresAggregateRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListSquaresAggregateResponse = {
  encode(message: ListSquaresAggregateResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    for (const v of message.squaresAggregate) {
      SquareAggregate.encode(v!, writer.uint32(10).fork()).ldelim();
    }
    if (message.nextPageToken !== "") {
      writer.uint32(18).string(message.nextPageToken);
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ListSquaresAggregateResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const AggregateServiceServiceName = "blast.v1.aggregate.AggregateService";
export class AggregateServiceClientImpl implements AggregateService {
  private readonly rpc: Rpc;
  private readonly service: string;
  constructor(rpc: Rpc, opts?: { service?: string }) {
    this.service = opts?.service || AggregateServiceServiceName;
    this.rpc = rpc;
    this.ListPointsAggregate = this.ListPointsAggregate.bind(this);
    this.ListSquareMemberRankingsAggregate = this.ListSquareMemberRankingsAggregate.bind(this);
    this.GetSquareAggregate = this.GetSquareAggregate.bind(this);
    this.ListSquaresAggregate = this.ListSquaresAggregate.bind(this);
  }
  ListPointsAggregate(request: ListPointsAggregateRequest): Promise<ListPointsAggregateResponse> {
    const data = ListPointsAggregateRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "ListPointsAggregate", data);
    return promise.then((data) => ListPointsAggregateResponse.decode(_m0.Reader.create(data)));
  }

  ListSquareMemberRankingsAggregate(
    request: ListSquareMemberRankingsAggregateRequest,
  ): Promise<ListSquareMemberRankingsAggregateResponse> {
    const data = ListSquareMemberRankingsAggregateRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "ListSquareMemberRankingsAggregate", data);
    return promise.then((data) => ListSquareMemberRankingsAggregateResponse.decode(_m0.Reader.create(data)));
  }

  GetSquareAggregate(request: GetSquareAggregateRequest): Promise<SquareAggregate> {
    const data = GetSquareAggregateRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "GetSquareAggregate", data);
    return promise.then((data) => SquareAggregate.decode(_m0.Reader.create(data)));
  }

  ListSquaresAggregate(request: ListSquaresAggregateRequest): Promise<ListSquaresAggregateResponse> {
    const data = ListSquaresAggregateRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "ListSquaresAggregate", data);
    return promise.then((data) => ListSquaresAggregateResponse.decode(_m0.Reader.create(data)));
  }
}
