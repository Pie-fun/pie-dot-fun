...
export const GetPointsRequest = {
  encode(message: GetPointsRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.points !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): GetPointsRequest {
...
export const ListPointsRequest = {
  encode(message: ListPointsRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ListPointsRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListPointsResponse = {
  encode(message: ListPointsResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    for (const v of message.points) {
      Points.encode(v!, writer.uint32(10).fork()).ldelim();
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ListPointsResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const EarnStakingInterestRequest = {
  encode(message: EarnStakingInterestRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.points !== "") {
      writer.uint32(10).string(message.points);
    }
    return writer;
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): EarnStakingInterestRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListPointsReferralBonusesRequest = {
  encode(message: ListPointsReferralBonusesRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.pageSize !== 0) {
      writer.uint32(8).int32(message.pageSize);
    }
    if (message.pageToken !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ListPointsReferralBonusesRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListPointsReferralBonusesResponse = {
  encode(message: ListPointsReferralBonusesResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    for (const v of message.referralBonuses) {
      PointsReferralBonus.encode(v!, writer.uint32(10).fork()).ldelim();
    }
    if (message.nextPageToken !== "") {
      writer.uint32(18).string(message.nextPageToken);
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ListPointsReferralBonusesResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Bonus = {
  encode(message: Bonus, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): Bonus {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Multiplier = {
  ...
  fromJSON(object: any): Multiplier {
    return {
      type: isSet(object.type) ? multiplierTypeFromJSON(object.type) : 0,
...
function createBasePointsHistory(): PointsHistory {
  return { userAddress: "", amount: 0, pointsType: 0, pointsTypeBehaviorGroup: 0 };
}

export const PointsHistory = {
  encode(message: PointsHistory, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.userAddress !== "") {
    ...
    if (message.pointsTypeBehaviorGroup !== 0) {
      writer.uint32(32).int32(message.pointsTypeBehaviorGroup);
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): PointsHistory {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4:
          ...
          message.pointsTypeBehaviorGroup = reader.int32() as any;
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): PointsHistory {
    return {
      ...
      pointsType: isSet(object.pointsType) ? pointsTypeFromJSON(object.pointsType) : 0,
  ...
  fromPartial<I extends Exact<DeepPartial<PointsHistory>, I>>(object: I): PointsHistory {
    ...
    message.pointsTypeBehaviorGroup = object.pointsTypeBehaviorGroup ?? 0;
    return message;
  },
};
...
export const PointsReferralBonus = {
  encode(message: PointsReferralBonus, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.referred !== undefined) {
      User.encode(message.referred, writer.uint32(10).fork()).ldelim();
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): PointsReferralBonus {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const PointsServiceServiceName = "blast.v1.points.PointsService";
export class PointsServiceClientImpl implements PointsService {
  ...
  constructor(rpc: Rpc, opts?: { service?: string }) {
    ...
    this.ListPoints = this.ListPoints.bind(this);
    this.EarnStakingInterest = this.EarnStakingInterest.bind(this);
  }
  GetPoints(request: GetPointsRequest): Promise<Points> {
    const data = GetPointsRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "GetPoints", data);
    return promise.then((data) => Points.decode(_m0.Reader.create(data)));
  }

  ListPoints(request: ListPointsRequest): Promise<ListPointsResponse> {
    const data = ListPointsRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "ListPoints", data);
    return promise.then((data) => ListPointsResponse.decode(_m0.Reader.create(data)));
  }

  EarnStakingInterest(request: EarnStakingInterestRequest): Promise<Points> {
    const data = EarnStakingInterestRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "EarnStakingInterest", data);
    return promise.then((data) => Points.decode(_m0.Reader.create(data)));
  }
}
