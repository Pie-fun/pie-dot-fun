...
import { ChainType, chainTypeFromJSON, chainTypeToJSON, Percentage, Quantity } from "./common";
...
export const BasketToken = {
  encode(message: BasketToken, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.strategy !== 0) {
      writer.uint32(80).int32(message.strategy);
    }
    if (message.rebalanceFrequency !== 0) {
      writer.uint32(88).int32(message.rebalanceFrequency);
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 11:
          ...
          message.rebalanceFrequency = reader.int32() as any;
          continue;
        case 12:
          if (tag !== 96) {
            break;
  ...
  fromJSON(object: any): BasketToken {
    return {
      ...
      state: isSet(object.state) ? basketTokenStateFromJSON(object.state) : 0,
      strategy: isSet(object.strategy) ? tokenStrategyFromJSON(object.strategy) : 0,
      rebalanceFrequency: isSet(object.rebalanceFrequency) ? rebalanceFrequencyFromJSON(object.rebalanceFrequency) : 0,
  ...
  fromPartial<I extends Exact<DeepPartial<BasketToken>, I>>(object: I): BasketToken {
    ...
    message.rebalanceFrequency = object.rebalanceFrequency ?? 0;
...
function createBaseComponent(): Component {
  return { fungibleToken: "", chain: 0, address: "", weight: undefined };
}
