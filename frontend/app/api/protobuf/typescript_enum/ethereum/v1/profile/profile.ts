...
import { ChainType, chainTypeFromJSON, chainTypeToJSON } from "../outpost/nft";
import { MySpace } from "./my_space";
import { SNSType, sNSTypeFromJSON, sNSTypeToJSON } from "./sns_connection";
...
function createBaseListProfilesRequest(): ListProfilesRequest {
  return { pageSize: 0, pageToken: "", filter: "", view: 0 };
}

export const ListProfilesRequest = {
  encode(message: ListProfilesRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ListProfilesRequest {
  ...
  fromJSON(object: any): ListProfilesRequest {
    return {
      ...
      view: isSet(object.view) ? profileViewFromJSON(object.view) : 0,
    };
  },
...
export const ListProfilesResponse = {
  encode(message: ListProfilesResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ListProfilesResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CompleteTutorialRequest = {
  encode(message: CompleteTutorialRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.profile !== "") {
      writer.uint32(10).string(message.profile);
    }
    return writer;
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): CompleteTutorialRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CompleteTutorialResponse = {
  encode(message: CompleteTutorialResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.tutorialId !== "") {
      writer.uint32(10).string(message.tutorialId);
    }
    if (message.completedTimestamp !== undefined) {
      Timestamp.encode(toTimestamp(message.completedTimestamp), writer.uint32(18).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): CompleteTutorialResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetMySpaceRequest = {
  encode(message: GetMySpaceRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.profile !== "") {
      writer.uint32(10).string(message.profile);
    }
    return writer;
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): GetMySpaceRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const UpdateMySpaceRequest = {
  encode(message: UpdateMySpaceRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.profile !== "") {
      writer.uint32(10).string(message.profile);
    }
    if (message.mySpace !== undefined) {
      MySpace.encode(message.mySpace, writer.uint32(18).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): UpdateMySpaceRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetProfileDailyPlayCountRequest = {
  encode(message: GetProfileDailyPlayCountRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.profile !== "") {
      writer.uint32(10).string(message.profile);
    }
    return writer;
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): GetProfileDailyPlayCountRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetProfileDailyPlayCountResponse = {
  encode(message: GetProfileDailyPlayCountResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): GetProfileDailyPlayCountResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const IncrementProfileDailyPlayCountRequest = {
  encode(message: IncrementProfileDailyPlayCountRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.profile !== "") {
      writer.uint32(10).string(message.profile);
    }
    return writer;
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): IncrementProfileDailyPlayCountRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const IncrementProfileDailyPlayCountResponse = {
  encode(message: IncrementProfileDailyPlayCountResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.dailyPlayCount !== 0) {
      writer.uint32(8).uint32(message.dailyPlayCount);
    }
    return writer;
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): IncrementProfileDailyPlayCountResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
function createBaseConnectSNSRequest(): ConnectSNSRequest {
  return { profile: "", snsType: 0, accessToken: "", accessTokenSecret: "" };
}

export const ConnectSNSRequest = {
  encode(message: ConnectSNSRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.profile !== "") {
      writer.uint32(10).string(message.profile);
    }
    if (message.snsType !== 0) {
      writer.uint32(16).int32(message.snsType);
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ConnectSNSRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          message.snsType = reader.int32() as any;
          continue;
        case 3:
          if (tag !== 26) {
            break;
  ...
  fromJSON(object: any): ConnectSNSRequest {
    return {
      profile: isSet(object.profile) ? globalThis.String(object.profile) : "",
      snsType: isSet(object.snsType) ? sNSTypeFromJSON(object.snsType) : 0,
  ...
  fromPartial<I extends Exact<DeepPartial<ConnectSNSRequest>, I>>(object: I): ConnectSNSRequest {
    const message = createBaseConnectSNSRequest();
    message.profile = object.profile ?? "";
    message.snsType = object.snsType ?? 0;
...
export const Profile = {
  encode(message: Profile, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.nft !== undefined) {
      ProfileNFT.encode(message.nft, writer.uint32(58).fork()).ldelim();
    }
    if (message.starAccount !== undefined) {
      StarAccount.encode(message.starAccount, writer.uint32(66).fork()).ldelim();
    }
  ...
  fromJSON(object: any): Profile {
    return {
      ...
      state: isSet(object.state) ? profileStateFromJSON(object.state) : 0,
...
export const Tutorial = {
  encode(message: Tutorial, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.isDone !== false) {
      writer.uint32(8).bool(message.isDone);
    }
    if (message.completeTime !== undefined) {
      Timestamp.encode(toTimestamp(message.completeTime), writer.uint32(18).fork()).ldelim();
    }
    return writer;
  },
...
export const StarAccount = {
  encode(message: StarAccount, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): StarAccount {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GMStatsSlim = {
  encode(message: GMStatsSlim, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): GMStatsSlim {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ProfileNFT = {
  encode(message: ProfileNFT, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.name !== "") {
      writer.uint32(10).string(message.name);
    }
    if (message.tokenId !== "") {
    ...
    if (message.contract !== undefined) {
      ProfileNFTContract.encode(message.contract, writer.uint32(42).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): ProfileNFT {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ProfileNFTContract = {
  encode(message: ProfileNFTContract, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.address !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ProfileNFTContract {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ProfileServiceServiceName = "ethereum.v1.profile.ProfileService";
export class ProfileServiceClientImpl implements ProfileService {
  ...
  constructor(rpc: Rpc, opts?: { service?: string }) {
    ...
    this.GetMySpace = this.GetMySpace.bind(this);
    this.UpdateMySpace = this.UpdateMySpace.bind(this);
    this.GetProfileDailyPlayCount = this.GetProfileDailyPlayCount.bind(this);
    this.IncrementProfileDailyPlayCount = this.IncrementProfileDailyPlayCount.bind(this);
  }
  ListProfiles(request: ListProfilesRequest): Promise<ListProfilesResponse> {
    const data = ListProfilesRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "ListProfiles", data);
    return promise.then((data) => ListProfilesResponse.decode(_m0.Reader.create(data)));
  }

  GetProfile(request: GetProfileRequest): Promise<Profile> {
    const data = GetProfileRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "GetProfile", data);
    return promise.then((data) => Profile.decode(_m0.Reader.create(data)));
  }
  ...
  GetMySpace(request: GetMySpaceRequest): Promise<MySpace> {
    const data = GetMySpaceRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "GetMySpace", data);
    return promise.then((data) => MySpace.decode(_m0.Reader.create(data)));
  }

  UpdateMySpace(request: UpdateMySpaceRequest): Promise<MySpace> {
    const data = UpdateMySpaceRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "UpdateMySpace", data);
    return promise.then((data) => MySpace.decode(_m0.Reader.create(data)));
  }

  GetProfileDailyPlayCount(request: GetProfileDailyPlayCountRequest): Promise<GetProfileDailyPlayCountResponse> {
    const data = GetProfileDailyPlayCountRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "GetProfileDailyPlayCount", data);
    return promise.then((data) => GetProfileDailyPlayCountResponse.decode(_m0.Reader.create(data)));
  }

  IncrementProfileDailyPlayCount(
    request: IncrementProfileDailyPlayCountRequest,
  ): Promise<IncrementProfileDailyPlayCountResponse> {
    const data = IncrementProfileDailyPlayCountRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "IncrementProfileDailyPlayCount", data);
    return promise.then((data) => IncrementProfileDailyPlayCountResponse.decode(_m0.Reader.create(data)));
  }
}
