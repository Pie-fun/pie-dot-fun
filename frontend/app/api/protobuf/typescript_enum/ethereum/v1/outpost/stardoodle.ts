...
export const ListStarDoodlesRequest = {
  encode(message: ListStarDoodlesRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.filter !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ListStarDoodlesRequest {
...
export const ListStarDoodlesResponse = {
  encode(message: ListStarDoodlesResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    for (const v of message.starDoodles) {
      StarDoodle.encode(v!, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): ListStarDoodlesResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
function createBaseStarDoodle(): StarDoodle {
  return { doodler: "", locationType: 0, position: undefined };
}

export const StarDoodle = {
  encode(message: StarDoodle, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.doodler !== "") {
      writer.uint32(10).string(message.doodler);
    }
    if (message.locationType !== 0) {
      writer.uint32(16).int32(message.locationType);
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): StarDoodle {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): StarDoodle {
    return {
      ...
      locationType: isSet(object.locationType) ? starDoodle_LocationTypeFromJSON(object.locationType) : 0,
...
export const Star = {
  ...
  fromJSON(object: any): Star {
    return { color: isSet(object.color) ? star_StarColorFromJSON(object.color) : 0 };
  },
...
export const StarDoodleServiceServiceName = "ethereum.v1.outpost.StarDoodleService";
export class StarDoodleServiceClientImpl implements StarDoodleService {
  private readonly rpc: Rpc;
  private readonly service: string;
  constructor(rpc: Rpc, opts?: { service?: string }) {
    this.service = opts?.service || StarDoodleServiceServiceName;
    this.rpc = rpc;
    this.ListStarDoodles = this.ListStarDoodles.bind(this);
  }
  ListStarDoodles(request: ListStarDoodlesRequest): Promise<ListStarDoodlesResponse> {
    const data = ListStarDoodlesRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "ListStarDoodles", data);
    return promise.then((data) => ListStarDoodlesResponse.decode(_m0.Reader.create(data)));
  }
}
