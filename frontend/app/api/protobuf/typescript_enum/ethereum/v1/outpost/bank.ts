...
function createBaseBalance(): Balance {
  return { symbol: 0, amount: 0, cumulativeTotal: 0 };
}
...
function createBaseTransaction(): Transaction {
  return { id: 0, type: 0, money: undefined, recipient: undefined, createTime: undefined };
}
...
export const Transaction = {
  ...
  fromJSON(object: any): Transaction {
    return {
      ...
      type: isSet(object.type) ? transaction_TypeFromJSON(object.type) : 0,
