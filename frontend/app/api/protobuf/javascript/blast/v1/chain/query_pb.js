...
export const QueryReceiptRequest = proto3.makeMessageType(
  "blast.v1.chain.QueryReceiptRequest",
  () => [
...
export const QueryQueryTransactionCountRequest = proto3.makeMessageType(
  "blast.v1.chain.QueryQueryTransactionCountRequest",
  () => [
...
export const QueryQueryTransactionCountResponse = proto3.makeMessageType(
  "blast.v1.chain.QueryQueryTransactionCountResponse",
  () => [
...
export const QueryDelegateCashRequest = proto3.makeMessageType(
  "blast.v1.chain.QueryDelegateCashRequest",
  () => [
    { no: 1, name: "address", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
export const QueryDelegateCashResponse = proto3.makeMessageType(
  "blast.v1.chain.QueryDelegateCashResponse",
  () => [
 ...
 */
export const QueryStakingContractAddressRequest = proto3.makeMessageType(
  "blast.v1.chain.QueryStakingContractAddressRequest",
  () => [
    { no: 1, name: "address", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ],
);
 ...
 */
export const QueryStakingContractAddressResponse = proto3.makeMessageType(
  "blast.v1.chain.QueryStakingContractAddressResponse",
  () => [
 ...
 */
export const QueryStakingAmountRequest = proto3.makeMessageType(
  "blast.v1.chain.QueryStakingAmountRequest",
  () => [
    { no: 1, name: "address", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ],
);
 ...
 */
export const QueryStakingAmountResponse = proto3.makeMessageType(
  "blast.v1.chain.QueryStakingAmountResponse",
  () => [
    { no: 1, name: "staking_amount", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ],
);
 ...
 */
export const QueryOwnerOfRequest = proto3.makeMessageType(
  "blast.v1.chain.QueryOwnerOfRequest",
  () => [
    { no: 1, name: "contract_address", kind: "scalar", T: 9 /* ScalarType.STRING */ },
 ...
 */
export const QueryOwnerOfResponse = proto3.makeMessageType(
  "blast.v1.chain.QueryOwnerOfResponse",
  () => [
 ...
 */
export const QueryBalanceOfRequest = proto3.makeMessageType(
  "blast.v1.chain.QueryBalanceOfRequest",
  () => [
    { no: 1, name: "contract_address", kind: "scalar", T: 9 /* ScalarType.STRING */ },
 ...
 */
export const QueryBalanceOfResponse = proto3.makeMessageType(
  "blast.v1.chain.QueryBalanceOfResponse",
  () => [
...
export const MintScoreEvent_ScoreCategory = proto3.makeEnum(
  "blast.v1.chain.MintScoreEvent.ScoreCategory",
  [
...
export const DeployTBAAndMintProtoShipEvent = proto3.makeMessageType(
  "blast.v1.chain.DeployTBAAndMintProtoShipEvent",
  () => [
