...
export function squareViewToNumber(object: SquareView): number {
  switch (object) {
    case SquareView.SQUARE_VIEW_UNSPECIFIED:
      return 0;
    case SquareView.SQUARE_VIEW_OWNER:
...
export function squareStateToNumber(object: SquareState): number {
  switch (object) {
    case SquareState.STATE_UNSPECIFIED:
      return 0;
    case SquareState.CREATED_PENDING:
...
export function squareJoinTypeToNumber(object: SquareJoinType): number {
  switch (object) {
    case SquareJoinType.TYPE_UNSPECIFIED:
      return 0;
    case SquareJoinType.PUBLIC:
...
export function squareMemberTypeToNumber(object: SquareMemberType): number {
  switch (object) {
    case SquareMemberType.SQUARE_MEMBER_TYPE_UNSPECIFIED:
      return 0;
    case SquareMemberType.OWNER:
...
export function squareMemberRankTypeToNumber(object: SquareMemberRankType): number {
  switch (object) {
    case SquareMemberRankType.SQUARE_MEMBER_RANK_TYPE_UNSPECIFIED:
      return 0;
    case SquareMemberRankType.ALL_TIME:
...
export function rejectMintCodeToNumber(object: RejectMintCode): number {
  switch (object) {
    case RejectMintCode.REJECT_MINT_CODE_UNSPECIFIED:
      return 0;
    case RejectMintCode.NO_ELIGIBILITY:
...
export function rejectJoinSquareCodeToNumber(object: RejectJoinSquareCode): number {
  switch (object) {
    case RejectJoinSquareCode.REJECT_JOIN_CODE_UNSPECIFIED:
      return 0;
    case RejectJoinSquareCode.REJECT_JOIN_FULLY_OCCUPIED:
...
export function rejectTransferSquareCodeToNumber(object: RejectTransferSquareCode): number {
  switch (object) {
    case RejectTransferSquareCode.REJECT_TRANSFER_CODE_UNSPECIFIED:
      return 0;
    case RejectTransferSquareCode.REJECT_TRANSFER_FULLY_OCCUPIED:
...
export function mintEligibilityToNumber(object: MintEligibility): number {
  switch (object) {
    case MintEligibility.MINT_ELIGIBILITY_UNSPECIFIED:
      return 0;
    case MintEligibility.NOT_ELIGIBLE:
...
export function transferMemberTypeToNumber(object: TransferMemberType): number {
  switch (object) {
    case TransferMemberType.TRANSFER_MEMBER_TYPE_UNSPECIFIED:
      return 0;
    case TransferMemberType.DEFAULT:
...
export function spiritTypeToNumber(object: SpiritType): number {
  switch (object) {
    case SpiritType.SQUARE_SPIRIT_TYPE_UNSPECIFIED:
      return 0;
    case SpiritType.VOTING:
...
export const GetSquareRequest: MessageFns<GetSquareRequest> = {
  encode(message: GetSquareRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.square !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetSquareRequest {
...
export const ListSquaresRequest: MessageFns<ListSquaresRequest> = {
  encode(message: ListSquaresRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ListSquaresRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListSquaresResponse: MessageFns<ListSquaresResponse> = {
  encode(message: ListSquaresResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.squares) {
      Square.encode(v!, writer.uint32(10).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ListSquaresResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ValidateDisplayNameAvailabilityRequest: MessageFns<ValidateDisplayNameAvailabilityRequest> = {
  encode(message: ValidateDisplayNameAvailabilityRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ValidateDisplayNameAvailabilityRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ValidateDisplayNameAvailabilityResponse: MessageFns<ValidateDisplayNameAvailabilityResponse> = {
  encode(message: ValidateDisplayNameAvailabilityResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.displayName !== "") {
      writer.uint32(10).string(message.displayName);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ValidateDisplayNameAvailabilityResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CreateSquareAndSignRequest: MessageFns<CreateSquareAndSignRequest> = {
  encode(message: CreateSquareAndSignRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.nonce !== "") {
      writer.uint32(10).string(message.nonce);
    }
    if (message.square !== undefined) {
      Square.encode(message.square, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CreateSquareAndSignRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CreateSquareAndSignResponse: MessageFns<CreateSquareAndSignResponse> = {
  encode(message: CreateSquareAndSignResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.square !== undefined) {
      Square.encode(message.square, writer.uint32(10).fork()).join();
    }
    if (message.signature !== "") {
      writer.uint32(18).string(message.signature);
    }
    if (message.params !== undefined) {
      MintAndCreateSquareParams.encode(message.params, writer.uint32(26).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CreateSquareAndSignResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListUsersSquaresRequest: MessageFns<ListUsersSquaresRequest> = {
  encode(message: ListUsersSquaresRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.user !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ListUsersSquaresRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListUsersSquaresResponse: MessageFns<ListUsersSquaresResponse> = {
  encode(message: ListUsersSquaresResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.squares) {
      Square.encode(v!, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ListUsersSquaresResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const UpdateSquareRequest: MessageFns<UpdateSquareRequest> = {
  encode(message: UpdateSquareRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.square !== undefined) {
      Square.encode(message.square, writer.uint32(10).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): UpdateSquareRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetSquareWeeklySpiritsRequest: MessageFns<GetSquareWeeklySpiritsRequest> = {
  encode(message: GetSquareWeeklySpiritsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.square !== "") {
      writer.uint32(10).string(message.square);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetSquareWeeklySpiritsRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetSquareWeeklySpiritsResponse: MessageFns<GetSquareWeeklySpiritsResponse> = {
  encode(message: GetSquareWeeklySpiritsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetSquareWeeklySpiritsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CheckMintEligibilityRequest: MessageFns<CheckMintEligibilityRequest> = {
  encode(message: CheckMintEligibilityRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.user !== "") {
      writer.uint32(10).string(message.user);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CheckMintEligibilityRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
function createBaseCheckMintEligibilityResponse(): CheckMintEligibilityResponse {
  return {
    user: "",
    eligibility: MintEligibility.MINT_ELIGIBILITY_UNSPECIFIED,
    available: false,
    rejectCode: undefined,
  };
}

export const CheckMintEligibilityResponse: MessageFns<CheckMintEligibilityResponse> = {
  encode(message: CheckMintEligibilityResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.user !== "") {
      writer.uint32(10).string(message.user);
    }
    if (message.eligibility !== MintEligibility.MINT_ELIGIBILITY_UNSPECIFIED) {
      writer.uint32(16).int32(mintEligibilityToNumber(message.eligibility));
    }
    if (message.available !== false) {
      writer.uint32(24).bool(message.available);
    }
    if (message.rejectCode !== undefined) {
      writer.uint32(32).int32(rejectMintCodeToNumber(message.rejectCode));
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CheckMintEligibilityResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2: {
          ...
          message.eligibility = mintEligibilityFromJSON(reader.int32());
          continue;
        }
        case 3: {
          if (tag !== 24) {
        ...
        case 4: {
          ...
          message.rejectCode = rejectMintCodeFromJSON(reader.int32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): CheckMintEligibilityResponse {
    return {
      ...
      eligibility: isSet(object.eligibility)
        ? mintEligibilityFromJSON(object.eligibility)
        : MintEligibility.MINT_ELIGIBILITY_UNSPECIFIED,
      available: isSet(object.available) ? globalThis.Boolean(object.available) : false,
  ...
  fromPartial<I extends Exact<DeepPartial<CheckMintEligibilityResponse>, I>>(object: I): CheckMintEligibilityResponse {
    const message = createBaseCheckMintEligibilityResponse();
    message.user = object.user ?? "";
    message.eligibility = object.eligibility ?? MintEligibility.MINT_ELIGIBILITY_UNSPECIFIED;
    message.available = object.available ?? false;
...
export const ApproveJoinSquareAndSignRequest: MessageFns<ApproveJoinSquareAndSignRequest> = {
  encode(message: ApproveJoinSquareAndSignRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.square !== "") {
      writer.uint32(10).string(message.square);
    }
    if (message.user !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ApproveJoinSquareAndSignRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ApproveJoinSquareAndSignResponse: MessageFns<ApproveJoinSquareAndSignResponse> = {
  encode(message: ApproveJoinSquareAndSignResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.rejectCode !== undefined) {
      writer.uint32(24).int32(rejectJoinSquareCodeToNumber(message.rejectCode));
    }
    if (message.params !== undefined) {
      JoinSquareParams.encode(message.params, writer.uint32(34).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ApproveJoinSquareAndSignResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3: {
          ...
          message.rejectCode = rejectJoinSquareCodeFromJSON(reader.int32());
          continue;
        }
        case 4: {
          if (tag !== 34) {
...
export const ApproveTransferSquareAndSignRequest: MessageFns<ApproveTransferSquareAndSignRequest> = {
  encode(message: ApproveTransferSquareAndSignRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.square !== "") {
      writer.uint32(10).string(message.square);
    }
    if (message.user !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ApproveTransferSquareAndSignRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ApproveTransferSquareAndSignResponse: MessageFns<ApproveTransferSquareAndSignResponse> = {
  encode(message: ApproveTransferSquareAndSignResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.approved !== false) {
      writer.uint32(8).bool(message.approved);
    }
    if (message.signature !== "") {
    ...
    if (message.rejectCode !== undefined) {
      writer.uint32(24).int32(rejectTransferSquareCodeToNumber(message.rejectCode));
    }
    if (message.params !== undefined) {
      TransferSquareParams.encode(message.params, writer.uint32(34).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ApproveTransferSquareAndSignResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3: {
          ...
          message.rejectCode = rejectTransferSquareCodeFromJSON(reader.int32());
          continue;
        }
        case 4: {
          if (tag !== 34) {
...
export const GetSquareWeeklyPointsRequest: MessageFns<GetSquareWeeklyPointsRequest> = {
  encode(message: GetSquareWeeklyPointsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.square !== "") {
      writer.uint32(10).string(message.square);
    }
    if (message.week !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetSquareWeeklyPointsRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetSquareWeeklyPointsResponse: MessageFns<GetSquareWeeklyPointsResponse> = {
  encode(message: GetSquareWeeklyPointsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetSquareWeeklyPointsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListSquareSpiritHistoriesRequest: MessageFns<ListSquareSpiritHistoriesRequest> = {
  encode(message: ListSquareSpiritHistoriesRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.square !== "") {
      writer.uint32(10).string(message.square);
    }
    if (message.pageSize !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ListSquareSpiritHistoriesRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListSquareSpiritHistoriesResposne: MessageFns<ListSquareSpiritHistoriesResposne> = {
  encode(message: ListSquareSpiritHistoriesResposne, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.histories) {
      SquareSpiritHistory.encode(v!, writer.uint32(10).fork()).join();
    }
    if (message.nextPageToken !== "") {
      writer.uint32(18).string(message.nextPageToken);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ListSquareSpiritHistoriesResposne {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListSquareMembersRequest: MessageFns<ListSquareMembersRequest> = {
  encode(message: ListSquareMembersRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.square !== "") {
      writer.uint32(10).string(message.square);
    }
    if (message.pageSize !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ListSquareMembersRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListSquareMembersResponse: MessageFns<ListSquareMembersResponse> = {
  encode(message: ListSquareMembersResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.members) {
      SquareMember.encode(v!, writer.uint32(10).fork()).join();
    }
    if (message.nextPageToken !== "") {
      writer.uint32(18).string(message.nextPageToken);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ListSquareMembersResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListSquareMemberRankingsRequest: MessageFns<ListSquareMemberRankingsRequest> = {
  encode(message: ListSquareMemberRankingsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.square !== "") {
      writer.uint32(10).string(message.square);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ListSquareMemberRankingsRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListSquareMemberRankingsResponse: MessageFns<ListSquareMemberRankingsResponse> = {
  encode(message: ListSquareMemberRankingsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.rankings) {
      SquareMemberRanking.encode(v!, writer.uint32(10).fork()).join();
    }
    if (message.nextPageToken !== "") {
      writer.uint32(18).string(message.nextPageToken);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ListSquareMemberRankingsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Square: MessageFns<Square> = {
  encode(message: Square, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.name !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Square {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const PFPBoost: MessageFns<PFPBoost> = {
  encode(message: PFPBoost, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): PFPBoost {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Public: MessageFns<Public> = {
  encode(_: Public, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Public {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const TokenGated: MessageFns<TokenGated> = {
  encode(message: TokenGated, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.nftContract !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): TokenGated {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SquareNFT: MessageFns<SquareNFT> = {
  encode(message: SquareNFT, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SquareNFT {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SquareMember: MessageFns<SquareMember> = {
  encode(message: SquareMember, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.name !== "") {
      writer.uint32(10).string(message.name);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SquareMember {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SquareMemberRanking: MessageFns<SquareMemberRanking> = {
  encode(message: SquareMemberRanking, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.rank !== 0) {
    ...
    if (message.member !== undefined) {
      SquareMember.encode(message.member, writer.uint32(26).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): SquareMemberRanking {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
function createBaseSquareSpiritHistory(): SquareSpiritHistory {
  return { square: "", type: SpiritType.SQUARE_SPIRIT_TYPE_UNSPECIFIED, amount: 0, createTime: undefined };
}

export const SquareSpiritHistory: MessageFns<SquareSpiritHistory> = {
  encode(message: SquareSpiritHistory, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.square !== "") {
      writer.uint32(18).string(message.square);
    }
    if (message.type !== SpiritType.SQUARE_SPIRIT_TYPE_UNSPECIFIED) {
      writer.uint32(24).int32(spiritTypeToNumber(message.type));
    }
    if (message.amount !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SquareSpiritHistory {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3: {
          ...
          message.type = spiritTypeFromJSON(reader.int32());
          continue;
        }
        case 4: {
          if (tag !== 32) {
  ...
  fromJSON(object: any): SquareSpiritHistory {
    return {
      square: isSet(object.square) ? globalThis.String(object.square) : "",
      type: isSet(object.type) ? spiritTypeFromJSON(object.type) : SpiritType.SQUARE_SPIRIT_TYPE_UNSPECIFIED,
  ...
  fromPartial<I extends Exact<DeepPartial<SquareSpiritHistory>, I>>(object: I): SquareSpiritHistory {
    const message = createBaseSquareSpiritHistory();
    message.square = object.square ?? "";
    message.type = object.type ?? SpiritType.SQUARE_SPIRIT_TYPE_UNSPECIFIED;
...
export type SquareServiceService = typeof SquareServiceService;
export const SquareServiceService = {
  /** GetSquare will return Square. */
  getSquare: {
    path: "/blast.v1.square.SquareService/GetSquare",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: GetSquareRequest) => Buffer.from(GetSquareRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => GetSquareRequest.decode(value),
    responseSerialize: (value: Square) => Buffer.from(Square.encode(value).finish()),
    responseDeserialize: (value: Buffer) => Square.decode(value),
  },
  /** ListSquares will return Squares. */
  listSquares: {
    path: "/blast.v1.square.SquareService/ListSquares",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: ListSquaresRequest) => Buffer.from(ListSquaresRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => ListSquaresRequest.decode(value),
    responseSerialize: (value: ListSquaresResponse) => Buffer.from(ListSquaresResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => ListSquaresResponse.decode(value),
  },
  /** UpdateSquare update Square. */
  updateSquare: {
    path: "/blast.v1.square.SquareService/UpdateSquare",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: UpdateSquareRequest) => Buffer.from(UpdateSquareRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => UpdateSquareRequest.decode(value),
    responseSerialize: (value: Square) => Buffer.from(Square.encode(value).finish()),
    responseDeserialize: (value: Buffer) => Square.decode(value),
  },
  /** GetSquareWeeklySpirits will return weekly spirits of the Square. */
  getSquareWeeklySpirits: {
    path: "/blast.v1.square.SquareService/GetSquareWeeklySpirits",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: GetSquareWeeklySpiritsRequest) =>
      Buffer.from(GetSquareWeeklySpiritsRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => GetSquareWeeklySpiritsRequest.decode(value),
    responseSerialize: (value: GetSquareWeeklySpiritsResponse) =>
      Buffer.from(GetSquareWeeklySpiritsResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => GetSquareWeeklySpiritsResponse.decode(value),
  },
  /** CheckMintEligibility check if the user is eligible to mint the NFT of the Square. */
  checkMintEligibility: {
    path: "/blast.v1.square.SquareService/CheckMintEligibility",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: CheckMintEligibilityRequest) =>
      Buffer.from(CheckMintEligibilityRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => CheckMintEligibilityRequest.decode(value),
    responseSerialize: (value: CheckMintEligibilityResponse) =>
      Buffer.from(CheckMintEligibilityResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => CheckMintEligibilityResponse.decode(value),
  },
  /** ValidateDisplayNameAvailability check if the display name is available. */
  validateDisplayNameAvailability: {
    path: "/blast.v1.square.SquareService/ValidateDisplayNameAvailability",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: ValidateDisplayNameAvailabilityRequest) =>
      Buffer.from(ValidateDisplayNameAvailabilityRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => ValidateDisplayNameAvailabilityRequest.decode(value),
    responseSerialize: (value: ValidateDisplayNameAvailabilityResponse) =>
      Buffer.from(ValidateDisplayNameAvailabilityResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => ValidateDisplayNameAvailabilityResponse.decode(value),
  },
  /** CreateSquareAndSign create Square with CREATED_PENDING state and response with signature to sign the onchain tx. */
  createSquareAndSign: {
    path: "/blast.v1.square.SquareService/CreateSquareAndSign",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: CreateSquareAndSignRequest) =>
      Buffer.from(CreateSquareAndSignRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => CreateSquareAndSignRequest.decode(value),
    responseSerialize: (value: CreateSquareAndSignResponse) =>
      Buffer.from(CreateSquareAndSignResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => CreateSquareAndSignResponse.decode(value),
  },
  ...
  approveJoinSquareAndSign: {
    path: "/blast.v1.square.SquareService/ApproveJoinSquareAndSign",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: ApproveJoinSquareAndSignRequest) =>
      Buffer.from(ApproveJoinSquareAndSignRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => ApproveJoinSquareAndSignRequest.decode(value),
    responseSerialize: (value: ApproveJoinSquareAndSignResponse) =>
      Buffer.from(ApproveJoinSquareAndSignResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => ApproveJoinSquareAndSignResponse.decode(value),
  },
  ...
  approveTransferSquareAndSign: {
    path: "/blast.v1.square.SquareService/ApproveTransferSquareAndSign",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: ApproveTransferSquareAndSignRequest) =>
      Buffer.from(ApproveTransferSquareAndSignRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => ApproveTransferSquareAndSignRequest.decode(value),
    responseSerialize: (value: ApproveTransferSquareAndSignResponse) =>
      Buffer.from(ApproveTransferSquareAndSignResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => ApproveTransferSquareAndSignResponse.decode(value),
  },
  /** GetSquareWeeklyPoints will return Square. */
  getSquareWeeklyPoints: {
    path: "/blast.v1.square.SquareService/GetSquareWeeklyPoints",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: GetSquareWeeklyPointsRequest) =>
      Buffer.from(GetSquareWeeklyPointsRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => GetSquareWeeklyPointsRequest.decode(value),
    responseSerialize: (value: GetSquareWeeklyPointsResponse) =>
      Buffer.from(GetSquareWeeklyPointsResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => GetSquareWeeklyPointsResponse.decode(value),
  },
  /** ListSquareSpiritHistories will return the spirit history of the Square. */
  listSquareSpiritHistories: {
    path: "/blast.v1.square.SquareService/ListSquareSpiritHistories",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: ListSquareSpiritHistoriesRequest) =>
      Buffer.from(ListSquareSpiritHistoriesRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => ListSquareSpiritHistoriesRequest.decode(value),
    responseSerialize: (value: ListSquareSpiritHistoriesResposne) =>
      Buffer.from(ListSquareSpiritHistoriesResposne.encode(value).finish()),
    responseDeserialize: (value: Buffer) => ListSquareSpiritHistoriesResposne.decode(value),
  },
  /** ListSquareMembers will return the members of the Square. */
  listSquareMembers: {
    path: "/blast.v1.square.SquareService/ListSquareMembers",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: ListSquareMembersRequest) => Buffer.from(ListSquareMembersRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => ListSquareMembersRequest.decode(value),
    responseSerialize: (value: ListSquareMembersResponse) =>
      Buffer.from(ListSquareMembersResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => ListSquareMembersResponse.decode(value),
  },
  /** ListSquareMemberRankings will return the leaderboard of the Square. */
  listSquareMemberRankings: {
    path: "/blast.v1.square.SquareService/ListSquareMemberRankings",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: ListSquareMemberRankingsRequest) =>
      Buffer.from(ListSquareMemberRankingsRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => ListSquareMemberRankingsRequest.decode(value),
    responseSerialize: (value: ListSquareMemberRankingsResponse) =>
      Buffer.from(ListSquareMemberRankingsResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => ListSquareMemberRankingsResponse.decode(value),
  },
} as const;

export interface SquareServiceServer extends UntypedServiceImplementation {
  /** GetSquare will return Square. */
  getSquare: handleUnaryCall<GetSquareRequest, Square>;
  /** ListSquares will return Squares. */
  listSquares: handleUnaryCall<ListSquaresRequest, ListSquaresResponse>;
  /** UpdateSquare update Square. */
  updateSquare: handleUnaryCall<UpdateSquareRequest, Square>;
  /** GetSquareWeeklySpirits will return weekly spirits of the Square. */
  getSquareWeeklySpirits: handleUnaryCall<GetSquareWeeklySpiritsRequest, GetSquareWeeklySpiritsResponse>;
  /** CheckMintEligibility check if the user is eligible to mint the NFT of the Square. */
  checkMintEligibility: handleUnaryCall<CheckMintEligibilityRequest, CheckMintEligibilityResponse>;
  /** ValidateDisplayNameAvailability check if the display name is available. */
  validateDisplayNameAvailability: handleUnaryCall<
    ValidateDisplayNameAvailabilityRequest,
    ValidateDisplayNameAvailabilityResponse
  >;
  /** CreateSquareAndSign create Square with CREATED_PENDING state and response with signature to sign the onchain tx. */
  createSquareAndSign: handleUnaryCall<CreateSquareAndSignRequest, CreateSquareAndSignResponse>;
  /** ApproveJoinSquareAndSign verify the member join the square and return signature to sign the onchain tx. */
  approveJoinSquareAndSign: handleUnaryCall<ApproveJoinSquareAndSignRequest, ApproveJoinSquareAndSignResponse>;
  /** ApproveTransferSquareAndSign verify the member transfer the square and return signature to sign the onchain tx. */
  approveTransferSquareAndSign: handleUnaryCall<
    ApproveTransferSquareAndSignRequest,
    ApproveTransferSquareAndSignResponse
  >;
  /** GetSquareWeeklyPoints will return Square. */
  getSquareWeeklyPoints: handleUnaryCall<GetSquareWeeklyPointsRequest, GetSquareWeeklyPointsResponse>;
  /** ListSquareSpiritHistories will return the spirit history of the Square. */
  listSquareSpiritHistories: handleUnaryCall<ListSquareSpiritHistoriesRequest, ListSquareSpiritHistoriesResposne>;
  /** ListSquareMembers will return the members of the Square. */
  listSquareMembers: handleUnaryCall<ListSquareMembersRequest, ListSquareMembersResponse>;
  /** ListSquareMemberRankings will return the leaderboard of the Square. */
  listSquareMemberRankings: handleUnaryCall<ListSquareMemberRankingsRequest, ListSquareMemberRankingsResponse>;
}

export interface SquareServiceClient extends Client {
  /** GetSquare will return Square. */
  getSquare(
    request: GetSquareRequest,
    callback: (error: ServiceError | null, response: Square) => void,
  ): ClientUnaryCall;
  getSquare(
    request: GetSquareRequest,
    metadata: Metadata,
  ...
  /** ListSquares will return Squares. */
  listSquares(
    request: ListSquaresRequest,
    callback: (error: ServiceError | null, response: ListSquaresResponse) => void,
  ): ClientUnaryCall;
  listSquares(
    request: ListSquaresRequest,
    metadata: Metadata,
  ...
  /** GetSquareWeeklySpirits will return weekly spirits of the Square. */
  getSquareWeeklySpirits(
    request: GetSquareWeeklySpiritsRequest,
    callback: (error: ServiceError | null, response: GetSquareWeeklySpiritsResponse) => void,
  ): ClientUnaryCall;
  getSquareWeeklySpirits(
    request: GetSquareWeeklySpiritsRequest,
    metadata: Metadata,
  ...
  /** CheckMintEligibility check if the user is eligible to mint the NFT of the Square. */
  checkMintEligibility(
    request: CheckMintEligibilityRequest,
    callback: (error: ServiceError | null, response: CheckMintEligibilityResponse) => void,
  ): ClientUnaryCall;
  checkMintEligibility(
    request: CheckMintEligibilityRequest,
    metadata: Metadata,
  ...
  validateDisplayNameAvailability(
    ...
    callback: (error: ServiceError | null, response: ValidateDisplayNameAvailabilityResponse) => void,
  ): ClientUnaryCall;
  validateDisplayNameAvailability(
    request: ValidateDisplayNameAvailabilityRequest,
    metadata: Metadata,
  ...
  /** CreateSquareAndSign create Square with CREATED_PENDING state and response with signature to sign the onchain tx. */
  createSquareAndSign(
    request: CreateSquareAndSignRequest,
    callback: (error: ServiceError | null, response: CreateSquareAndSignResponse) => void,
  ): ClientUnaryCall;
  createSquareAndSign(
    request: CreateSquareAndSignRequest,
    metadata: Metadata,
  ...
  /** ApproveJoinSquareAndSign verify the member join the square and return signature to sign the onchain tx. */
  approveJoinSquareAndSign(
    request: ApproveJoinSquareAndSignRequest,
    callback: (error: ServiceError | null, response: ApproveJoinSquareAndSignResponse) => void,
  ): ClientUnaryCall;
  approveJoinSquareAndSign(
    request: ApproveJoinSquareAndSignRequest,
    metadata: Metadata,
  ...
  approveTransferSquareAndSign(
    ...
    callback: (error: ServiceError | null, response: ApproveTransferSquareAndSignResponse) => void,
  ): ClientUnaryCall;
  approveTransferSquareAndSign(
    request: ApproveTransferSquareAndSignRequest,
    metadata: Metadata,
  ...
  /** GetSquareWeeklyPoints will return Square. */
  getSquareWeeklyPoints(
    request: GetSquareWeeklyPointsRequest,
    callback: (error: ServiceError | null, response: GetSquareWeeklyPointsResponse) => void,
  ): ClientUnaryCall;
  getSquareWeeklyPoints(
    request: GetSquareWeeklyPointsRequest,
    metadata: Metadata,
  ...
  /** ListSquareSpiritHistories will return the spirit history of the Square. */
  listSquareSpiritHistories(
    request: ListSquareSpiritHistoriesRequest,
    callback: (error: ServiceError | null, response: ListSquareSpiritHistoriesResposne) => void,
  ): ClientUnaryCall;
  listSquareSpiritHistories(
    request: ListSquareSpiritHistoriesRequest,
    metadata: Metadata,
  ...
  /** ListSquareMembers will return the members of the Square. */
  listSquareMembers(
    request: ListSquareMembersRequest,
    callback: (error: ServiceError | null, response: ListSquareMembersResponse) => void,
  ): ClientUnaryCall;
  listSquareMembers(
    request: ListSquareMembersRequest,
    metadata: Metadata,
  ...
  /** ListSquareMemberRankings will return the leaderboard of the Square. */
  listSquareMemberRankings(
    request: ListSquareMemberRankingsRequest,
    callback: (error: ServiceError | null, response: ListSquareMemberRankingsResponse) => void,
  ): ClientUnaryCall;
  listSquareMemberRankings(
    request: ListSquareMemberRankingsRequest,
    metadata: Metadata,
...
export const SquareServiceClient = makeGenericClientConstructor(
  SquareServiceService,
  "blast.v1.square.SquareService",
) as unknown as {
  new (address: string, credentials: ChannelCredentials, options?: Partial<ClientOptions>): SquareServiceClient;
  service: typeof SquareServiceService;
  serviceName: string;
};
