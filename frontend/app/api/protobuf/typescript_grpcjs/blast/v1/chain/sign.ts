...
export const MintAndCreateSquareParams: MessageFns<MintAndCreateSquareParams> = {
  encode(message: MintAndCreateSquareParams, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.user !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MintAndCreateSquareParams {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SignMintSquareRequest: MessageFns<SignMintSquareRequest> = {
  encode(message: SignMintSquareRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.params !== undefined) {
      MintAndCreateSquareParams.encode(message.params, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): SignMintSquareRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SignMintSquareResponse: MessageFns<SignMintSquareResponse> = {
  encode(message: SignMintSquareResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.signature !== "") {
      writer.uint32(10).string(message.signature);
    }
    if (message.params !== undefined) {
      MintAndCreateSquareParams.encode(message.params, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): SignMintSquareResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const JoinSquareParams: MessageFns<JoinSquareParams> = {
  encode(message: JoinSquareParams, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.user !== "") {
      writer.uint32(10).string(message.user);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): JoinSquareParams {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SignJoinSquareRequest: MessageFns<SignJoinSquareRequest> = {
  encode(message: SignJoinSquareRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.params !== undefined) {
      JoinSquareParams.encode(message.params, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): SignJoinSquareRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SignJoinSquareResponse: MessageFns<SignJoinSquareResponse> = {
  encode(message: SignJoinSquareResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.signature !== "") {
      writer.uint32(10).string(message.signature);
    }
    if (message.params !== undefined) {
      JoinSquareParams.encode(message.params, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): SignJoinSquareResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const TransferSquareParams: MessageFns<TransferSquareParams> = {
  encode(message: TransferSquareParams, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.user !== "") {
      writer.uint32(10).string(message.user);
    }
    if (message.from !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): TransferSquareParams {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SignTransferSquareRequest: MessageFns<SignTransferSquareRequest> = {
  encode(message: SignTransferSquareRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.params !== undefined) {
      TransferSquareParams.encode(message.params, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): SignTransferSquareRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SignTransferSquareResponse: MessageFns<SignTransferSquareResponse> = {
  encode(message: SignTransferSquareResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.signature !== "") {
      writer.uint32(10).string(message.signature);
    }
    if (message.params !== undefined) {
      TransferSquareParams.encode(message.params, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): SignTransferSquareResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const UploadScoreParams: MessageFns<UploadScoreParams> = {
  encode(message: UploadScoreParams, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.player !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): UploadScoreParams {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SignUploadScoreRequest: MessageFns<SignUploadScoreRequest> = {
  encode(message: SignUploadScoreRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.params !== undefined) {
      UploadScoreParams.encode(message.params, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): SignUploadScoreRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SignUploadScoreResponse: MessageFns<SignUploadScoreResponse> = {
  encode(message: SignUploadScoreResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.signature !== "") {
      writer.uint32(10).string(message.signature);
    }
    if (message.params !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SignUploadScoreResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ChainSignServiceService = {
   ...
   */
  signMessage: {
    path: "/blast.v1.chain.ChainSignService/SignMessage",
    requestStream: false,
   ...
   */
  signMintSquare: {
    path: "/blast.v1.chain.ChainSignService/SignMintSquare",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: SignMintSquareRequest) => Buffer.from(SignMintSquareRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => SignMintSquareRequest.decode(value),
    responseSerialize: (value: SignMintSquareResponse) => Buffer.from(SignMintSquareResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => SignMintSquareResponse.decode(value),
  },
  /** SignJoinSquare signs a square mint with the given parameters. */
  signJoinSquare: {
    path: "/blast.v1.chain.ChainSignService/SignJoinSquare",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: SignJoinSquareRequest) => Buffer.from(SignJoinSquareRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => SignJoinSquareRequest.decode(value),
    responseSerialize: (value: SignJoinSquareResponse) => Buffer.from(SignJoinSquareResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => SignJoinSquareResponse.decode(value),
  },
  /** SignTransferSquare signs a square mint with the given parameters. */
  signTransferSquare: {
    path: "/blast.v1.chain.ChainSignService/SignTransferSquare",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: SignTransferSquareRequest) =>
      Buffer.from(SignTransferSquareRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => SignTransferSquareRequest.decode(value),
    responseSerialize: (value: SignTransferSquareResponse) =>
      Buffer.from(SignTransferSquareResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => SignTransferSquareResponse.decode(value),
  },
  /** SignUploadScore signs a score creation with the given parameters. */
  signUploadScore: {
    path: "/blast.v1.chain.ChainSignService/SignUploadScore",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: SignUploadScoreRequest) => Buffer.from(SignUploadScoreRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => SignUploadScoreRequest.decode(value),
    responseSerialize: (value: SignUploadScoreResponse) => Buffer.from(SignUploadScoreResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => SignUploadScoreResponse.decode(value),
  },
} as const;
...
export interface ChainSignServiceServer extends UntypedServiceImplementation {
   ...
   * 403 error will be returned if the given owner address not not eligible to mint the square.
   */
  signMintSquare: handleUnaryCall<SignMintSquareRequest, SignMintSquareResponse>;
  /** SignJoinSquare signs a square mint with the given parameters. */
  signJoinSquare: handleUnaryCall<SignJoinSquareRequest, SignJoinSquareResponse>;
  /** SignTransferSquare signs a square mint with the given parameters. */
  signTransferSquare: handleUnaryCall<SignTransferSquareRequest, SignTransferSquareResponse>;
  /** SignUploadScore signs a score creation with the given parameters. */
  signUploadScore: handleUnaryCall<SignUploadScoreRequest, SignUploadScoreResponse>;
}
...
export interface ChainSignServiceClient extends Client {
   ...
   */
  signMintSquare(
    request: SignMintSquareRequest,
    callback: (error: ServiceError | null, response: SignMintSquareResponse) => void,
  ): ClientUnaryCall;
  signMintSquare(
    request: SignMintSquareRequest,
    metadata: Metadata,
  ...
  /** SignJoinSquare signs a square mint with the given parameters. */
  signJoinSquare(
    request: SignJoinSquareRequest,
    callback: (error: ServiceError | null, response: SignJoinSquareResponse) => void,
  ): ClientUnaryCall;
  signJoinSquare(
    request: SignJoinSquareRequest,
    metadata: Metadata,
  ...
  /** SignTransferSquare signs a square mint with the given parameters. */
  signTransferSquare(
    request: SignTransferSquareRequest,
    callback: (error: ServiceError | null, response: SignTransferSquareResponse) => void,
  ): ClientUnaryCall;
  signTransferSquare(
    request: SignTransferSquareRequest,
    metadata: Metadata,
  ...
  /** SignUploadScore signs a score creation with the given parameters. */
  signUploadScore(
    request: SignUploadScoreRequest,
    callback: (error: ServiceError | null, response: SignUploadScoreResponse) => void,
  ): ClientUnaryCall;
  signUploadScore(
    request: SignUploadScoreRequest,
    metadata: Metadata,
