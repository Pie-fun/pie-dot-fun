...
export function gameTypeToNumber(object: GameType): number {
  switch (object) {
    case GameType.GAME_TYPE_UNSPECIFIED:
      return 0;
    case GameType.STAR_SWEEPERS:
...
export function scoreStateToNumber(object: ScoreState): number {
  switch (object) {
    case ScoreState.SCORE_STATE_UNSPECIFIED:
      return 0;
    case ScoreState.CREATED:
...
export function scoreRankUserTypeToNumber(object: ScoreRankUserType): number {
  switch (object) {
    case ScoreRankUserType.SCORE_RANK_USER_TYPE_UNSPECIFIED:
      return 0;
    case ScoreRankUserType.ALL_USERS:
...
export function scoreRankTimePeriodToNumber(object: ScoreRankTimePeriod): number {
  switch (object) {
    case ScoreRankTimePeriod.SCORE_RANK_TIME_PERIOD_UNSPECIFIED:
      return 0;
    case ScoreRankTimePeriod.ALL_TIME:
...
export function scoreRankScoreTypeToNumber(object: ScoreRankScoreType): number {
  switch (object) {
    case ScoreRankScoreType.SCORE_RANK_SCORE_TYPE_UNSPECIFIED:
      return 0;
    case ScoreRankScoreType.BEST_SCORE:
...
export function scoreRankEntitiyTypeToNumber(object: ScoreRankEntitiyType): number {
  switch (object) {
    case ScoreRankEntitiyType.SCORE_RANK_ENTITY_TYPE_UNSPECIFIED:
      return 0;
    case ScoreRankEntitiyType.USER:
...
export function rewardRequest_RewardTypeToNumber(object: RewardRequest_RewardType): number {
  switch (object) {
    case RewardRequest_RewardType.REWARD_TYPE_UNSPECIFIED:
      return 0;
    case RewardRequest_RewardType.WEEKLY_ALL_USERS_LEADERBOARD:
...
function createBaseRewardRequest(): RewardRequest {
  return { type: RewardRequest_RewardType.REWARD_TYPE_UNSPECIFIED };
}

export const RewardRequest: MessageFns<RewardRequest> = {
  encode(message: RewardRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.type !== RewardRequest_RewardType.REWARD_TYPE_UNSPECIFIED) {
      writer.uint32(8).int32(rewardRequest_RewardTypeToNumber(message.type));
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): RewardRequest {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.type = rewardRequest_RewardTypeFromJSON(reader.int32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): RewardRequest {
    return {
      type: isSet(object.type)
        ? rewardRequest_RewardTypeFromJSON(object.type)
        : RewardRequest_RewardType.REWARD_TYPE_UNSPECIFIED,
    };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<RewardRequest>, I>>(object: I): RewardRequest {
    const message = createBaseRewardRequest();
    message.type = object.type ?? RewardRequest_RewardType.REWARD_TYPE_UNSPECIFIED;
    return message;
  },
};
...
export const RewardResponse: MessageFns<RewardResponse> = {
  encode(message: RewardResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.userRewards) {
      RewardResponse_UserReward.encode(v!, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): RewardResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const RewardResponse_UserReward: MessageFns<RewardResponse_UserReward> = {
  encode(message: RewardResponse_UserReward, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.userAddress !== "") {
      writer.uint32(10).string(message.userAddress);
    }
    if (message.points !== undefined) {
      Decimal.encode(message.points, writer.uint32(18).fork()).join();
    }
    if (message.blastPoints !== undefined) {
      Decimal.encode(message.blastPoints, writer.uint32(26).fork()).join();
    }
    if (message.blastGold !== undefined) {
      Decimal.encode(message.blastGold, writer.uint32(34).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): RewardResponse_UserReward {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ValidateUploadScoreAndSignRequest: MessageFns<ValidateUploadScoreAndSignRequest> = {
  encode(message: ValidateUploadScoreAndSignRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.score !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ValidateUploadScoreAndSignRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ValidateUploadScoreAndSignResponse: MessageFns<ValidateUploadScoreAndSignResponse> = {
  encode(message: ValidateUploadScoreAndSignResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.signature !== "") {
      writer.uint32(10).string(message.signature);
    }
    if (message.params !== undefined) {
      UploadScoreParams.encode(message.params, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ValidateUploadScoreAndSignResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CreateScoreRequest: MessageFns<CreateScoreRequest> = {
  encode(message: CreateScoreRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.name !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CreateScoreRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetScoreRequest: MessageFns<GetScoreRequest> = {
  encode(message: GetScoreRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.score !== "") {
      writer.uint32(10).string(message.score);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetScoreRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
function createBaseGetUserBestScoreRankingRequest(): GetUserBestScoreRankingRequest {
  return {
    userBestScoreRanking: "",
    userType: ScoreRankUserType.SCORE_RANK_USER_TYPE_UNSPECIFIED,
    timePeriod: ScoreRankTimePeriod.SCORE_RANK_TIME_PERIOD_UNSPECIFIED,
    context: "",
  };
}

export const GetUserBestScoreRankingRequest: MessageFns<GetUserBestScoreRankingRequest> = {
  encode(message: GetUserBestScoreRankingRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.userBestScoreRanking !== "") {
      writer.uint32(10).string(message.userBestScoreRanking);
    }
    if (message.userType !== ScoreRankUserType.SCORE_RANK_USER_TYPE_UNSPECIFIED) {
      writer.uint32(16).int32(scoreRankUserTypeToNumber(message.userType));
    }
    if (message.timePeriod !== ScoreRankTimePeriod.SCORE_RANK_TIME_PERIOD_UNSPECIFIED) {
      writer.uint32(24).int32(scoreRankTimePeriodToNumber(message.timePeriod));
    }
    if (message.context !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetUserBestScoreRankingRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2: {
          ...
          message.userType = scoreRankUserTypeFromJSON(reader.int32());
          continue;
        }
        case 3: {
          if (tag !== 24) {
          ...
          message.timePeriod = scoreRankTimePeriodFromJSON(reader.int32());
          continue;
        }
        case 4: {
          if (tag !== 34) {
  ...
  fromJSON(object: any): GetUserBestScoreRankingRequest {
    return {
      ...
      userType: isSet(object.userType)
        ? scoreRankUserTypeFromJSON(object.userType)
        : ScoreRankUserType.SCORE_RANK_USER_TYPE_UNSPECIFIED,
      timePeriod: isSet(object.timePeriod)
        ? scoreRankTimePeriodFromJSON(object.timePeriod)
        : ScoreRankTimePeriod.SCORE_RANK_TIME_PERIOD_UNSPECIFIED,
  ...
  fromPartial<I extends Exact<DeepPartial<GetUserBestScoreRankingRequest>, I>>(
    ...
    message.userType = object.userType ?? ScoreRankUserType.SCORE_RANK_USER_TYPE_UNSPECIFIED;
    message.timePeriod = object.timePeriod ?? ScoreRankTimePeriod.SCORE_RANK_TIME_PERIOD_UNSPECIFIED;
...
export const ListUserBestScoreRankingsRequest: MessageFns<ListUserBestScoreRankingsRequest> = {
  encode(message: ListUserBestScoreRankingsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.userType !== ScoreRankUserType.SCORE_RANK_USER_TYPE_UNSPECIFIED) {
      writer.uint32(8).int32(scoreRankUserTypeToNumber(message.userType));
    }
    if (message.timePeriod !== ScoreRankTimePeriod.SCORE_RANK_TIME_PERIOD_UNSPECIFIED) {
      writer.uint32(16).int32(scoreRankTimePeriodToNumber(message.timePeriod));
    }
    if (message.context !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ListUserBestScoreRankingsRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListUserBestScoreRankingsResponse: MessageFns<ListUserBestScoreRankingsResponse> = {
  encode(message: ListUserBestScoreRankingsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.rankings) {
      UserBestScoreRanking.encode(v!, writer.uint32(10).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ListUserBestScoreRankingsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetUserCumulativeScoreRankingRequest: MessageFns<GetUserCumulativeScoreRankingRequest> = {
  encode(message: GetUserCumulativeScoreRankingRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetUserCumulativeScoreRankingRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListUserCumulativeScoreRankingsRequest: MessageFns<ListUserCumulativeScoreRankingsRequest> = {
  encode(message: ListUserCumulativeScoreRankingsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.userType !== ScoreRankUserType.SCORE_RANK_USER_TYPE_UNSPECIFIED) {
      writer.uint32(8).int32(scoreRankUserTypeToNumber(message.userType));
    }
    if (message.timePeriod !== ScoreRankTimePeriod.SCORE_RANK_TIME_PERIOD_UNSPECIFIED) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ListUserCumulativeScoreRankingsRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListUserCumulativeScoreRankingsResponse: MessageFns<ListUserCumulativeScoreRankingsResponse> = {
  encode(message: ListUserCumulativeScoreRankingsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.rankings) {
      UserCumulativeScoreRanking.encode(v!, writer.uint32(10).fork()).join();
    }
    if (message.nextPageToken !== "") {
      writer.uint32(18).string(message.nextPageToken);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ListUserCumulativeScoreRankingsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
function createBaseGetSquareCumulativeScoreRankingRequest(): GetSquareCumulativeScoreRankingRequest {
  return {
    squareCumulativeScoreRanking: "",
    timePeriod: ScoreRankTimePeriod.SCORE_RANK_TIME_PERIOD_UNSPECIFIED,
    context: undefined,
  };
}

export const GetSquareCumulativeScoreRankingRequest: MessageFns<GetSquareCumulativeScoreRankingRequest> = {
  encode(message: GetSquareCumulativeScoreRankingRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetSquareCumulativeScoreRankingRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListSquareCumulativeScoreRankingsRequest: MessageFns<ListSquareCumulativeScoreRankingsRequest> = {
  encode(message: ListSquareCumulativeScoreRankingsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.timePeriod !== ScoreRankTimePeriod.SCORE_RANK_TIME_PERIOD_UNSPECIFIED) {
      writer.uint32(8).int32(scoreRankTimePeriodToNumber(message.timePeriod));
    }
    if (message.context !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ListSquareCumulativeScoreRankingsRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListSquareCumulativeScoreRankingsResponse: MessageFns<ListSquareCumulativeScoreRankingsResponse> = {
  encode(message: ListSquareCumulativeScoreRankingsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.rankings) {
      SquareCumulativeScoreRanking.encode(v!, writer.uint32(10).fork()).join();
    }
    if (message.nextPageToken !== "") {
      writer.uint32(18).string(message.nextPageToken);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ListSquareCumulativeScoreRankingsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const InvalidateScoreRankingsByUserRequest: MessageFns<InvalidateScoreRankingsByUserRequest> = {
  encode(message: InvalidateScoreRankingsByUserRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): InvalidateScoreRankingsByUserRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
function createBaseScore(): Score {
  return {
    ...
    state: ScoreState.SCORE_STATE_UNSPECIFIED,
    points: 0,
    gameType: GameType.GAME_TYPE_UNSPECIFIED,
...
export const Score: MessageFns<Score> = {
  encode(message: Score, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.state !== ScoreState.SCORE_STATE_UNSPECIFIED) {
      writer.uint32(40).int32(scoreStateToNumber(message.state));
    }
    if (message.points !== 0) {
      writer.uint32(48).uint32(message.points);
    }
    if (message.gameType !== GameType.GAME_TYPE_UNSPECIFIED) {
      writer.uint32(64).int32(gameTypeToNumber(message.gameType));
    }
    if (message.playMode !== PlayMode.PLAY_MODE_UNSPECIFIED) {
      writer.uint32(72).int32(playModeToNumber(message.playMode));
    }
    if (message.week !== 0) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5: {
          ...
          message.state = scoreStateFromJSON(reader.int32());
          continue;
        }
        case 6: {
          if (tag !== 48) {
        ...
        case 8: {
          ...
          message.gameType = gameTypeFromJSON(reader.int32());
          continue;
        }
        case 9: {
          if (tag !== 72) {
  ...
  fromJSON(object: any): Score {
    return {
      ...
      state: isSet(object.state) ? scoreStateFromJSON(object.state) : ScoreState.SCORE_STATE_UNSPECIFIED,
      points: isSet(object.points) ? globalThis.Number(object.points) : 0,
      gameType: isSet(object.gameType) ? gameTypeFromJSON(object.gameType) : GameType.GAME_TYPE_UNSPECIFIED,
  ...
  fromPartial<I extends Exact<DeepPartial<Score>, I>>(object: I): Score {
    ...
    message.state = object.state ?? ScoreState.SCORE_STATE_UNSPECIFIED;
    message.points = object.points ?? 0;
    message.gameType = object.gameType ?? GameType.GAME_TYPE_UNSPECIFIED;
...
export const UserBestScoreRanking: MessageFns<UserBestScoreRanking> = {
  encode(message: UserBestScoreRanking, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.rank !== 0) {
    ...
    if (message.score !== undefined) {
      Score.encode(message.score, writer.uint32(34).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): UserBestScoreRanking {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const UserCumulativeScoreRanking: MessageFns<UserCumulativeScoreRanking> = {
  encode(message: UserCumulativeScoreRanking, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.rank !== 0) {
      writer.uint32(8).uint32(message.rank);
    }
    if (message.userType !== ScoreRankUserType.SCORE_RANK_USER_TYPE_UNSPECIFIED) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): UserCumulativeScoreRanking {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 6: {
          ...
          message.totalPoints = longToNumber(reader.uint64());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
...
export const SquareCumulativeScoreRanking: MessageFns<SquareCumulativeScoreRanking> = {
  encode(message: SquareCumulativeScoreRanking, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.rank !== 0) {
      writer.uint32(8).uint32(message.rank);
    }
    if (message.timePeriod !== ScoreRankTimePeriod.SCORE_RANK_TIME_PERIOD_UNSPECIFIED) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SquareCumulativeScoreRanking {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ScoreServiceService = {
  ...
  validateUploadScoreAndSign: {
    path: "/blast.v1.score.ScoreService/ValidateUploadScoreAndSign",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: ValidateUploadScoreAndSignRequest) =>
      Buffer.from(ValidateUploadScoreAndSignRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => ValidateUploadScoreAndSignRequest.decode(value),
    responseSerialize: (value: ValidateUploadScoreAndSignResponse) =>
      Buffer.from(ValidateUploadScoreAndSignResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => ValidateUploadScoreAndSignResponse.decode(value),
  },
  /** CreateScore create Score with Score */
  createScore: {
    path: "/blast.v1.score.ScoreService/CreateScore",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: CreateScoreRequest) => Buffer.from(CreateScoreRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => CreateScoreRequest.decode(value),
    responseSerialize: (value: Score) => Buffer.from(Score.encode(value).finish()),
    responseDeserialize: (value: Buffer) => Score.decode(value),
  },
  /** GetScore */
  getScore: {
    path: "/blast.v1.score.ScoreService/GetScore",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: GetScoreRequest) => Buffer.from(GetScoreRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => GetScoreRequest.decode(value),
    responseSerialize: (value: Score) => Buffer.from(Score.encode(value).finish()),
    responseDeserialize: (value: Buffer) => Score.decode(value),
  },
  /** GetUserBestScoreRanking */
  getUserBestScoreRanking: {
    path: "/blast.v1.score.ScoreService/GetUserBestScoreRanking",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: GetUserBestScoreRankingRequest) =>
      Buffer.from(GetUserBestScoreRankingRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => GetUserBestScoreRankingRequest.decode(value),
    responseSerialize: (value: UserBestScoreRanking) => Buffer.from(UserBestScoreRanking.encode(value).finish()),
    responseDeserialize: (value: Buffer) => UserBestScoreRanking.decode(value),
  },
  /** ListUserBestScoreRankings */
  listUserBestScoreRankings: {
    path: "/blast.v1.score.ScoreService/ListUserBestScoreRankings",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: ListUserBestScoreRankingsRequest) =>
      Buffer.from(ListUserBestScoreRankingsRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => ListUserBestScoreRankingsRequest.decode(value),
    responseSerialize: (value: ListUserBestScoreRankingsResponse) =>
      Buffer.from(ListUserBestScoreRankingsResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => ListUserBestScoreRankingsResponse.decode(value),
  },
  /** GetUserCumulativeScoreRanking */
  getUserCumulativeScoreRanking: {
    path: "/blast.v1.score.ScoreService/GetUserCumulativeScoreRanking",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: GetUserCumulativeScoreRankingRequest) =>
      Buffer.from(GetUserCumulativeScoreRankingRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => GetUserCumulativeScoreRankingRequest.decode(value),
    responseSerialize: (value: UserCumulativeScoreRanking) =>
      Buffer.from(UserCumulativeScoreRanking.encode(value).finish()),
    responseDeserialize: (value: Buffer) => UserCumulativeScoreRanking.decode(value),
  },
  /** ListUserCumulativeScoreRankings */
  listUserCumulativeScoreRankings: {
    path: "/blast.v1.score.ScoreService/ListUserCumulativeScoreRankings",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: ListUserCumulativeScoreRankingsRequest) =>
      Buffer.from(ListUserCumulativeScoreRankingsRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => ListUserCumulativeScoreRankingsRequest.decode(value),
    responseSerialize: (value: ListUserCumulativeScoreRankingsResponse) =>
      Buffer.from(ListUserCumulativeScoreRankingsResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => ListUserCumulativeScoreRankingsResponse.decode(value),
  },
  /** GetSquareCumulativeScoreRanking */
  getSquareCumulativeScoreRanking: {
    path: "/blast.v1.score.ScoreService/GetSquareCumulativeScoreRanking",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: GetSquareCumulativeScoreRankingRequest) =>
      Buffer.from(GetSquareCumulativeScoreRankingRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => GetSquareCumulativeScoreRankingRequest.decode(value),
    responseSerialize: (value: SquareCumulativeScoreRanking) =>
      Buffer.from(SquareCumulativeScoreRanking.encode(value).finish()),
    responseDeserialize: (value: Buffer) => SquareCumulativeScoreRanking.decode(value),
  },
  /** ListSquareCumulativeScoreRankings */
  listSquareCumulativeScoreRankings: {
    path: "/blast.v1.score.ScoreService/ListSquareCumulativeScoreRankings",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: ListSquareCumulativeScoreRankingsRequest) =>
      Buffer.from(ListSquareCumulativeScoreRankingsRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => ListSquareCumulativeScoreRankingsRequest.decode(value),
    responseSerialize: (value: ListSquareCumulativeScoreRankingsResponse) =>
      Buffer.from(ListSquareCumulativeScoreRankingsResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => ListSquareCumulativeScoreRankingsResponse.decode(value),
  },
  /** InvalidateScoreRankingsByUser */
  invalidateScoreRankingsByUser: {
    path: "/blast.v1.score.ScoreService/InvalidateScoreRankingsByUser",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: InvalidateScoreRankingsByUserRequest) =>
      Buffer.from(InvalidateScoreRankingsByUserRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => InvalidateScoreRankingsByUserRequest.decode(value),
   ...
   */
  dryRunReward: {
    path: "/blast.v1.score.ScoreService/DryRunReward",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: RewardRequest) => Buffer.from(RewardRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => RewardRequest.decode(value),
    responseSerialize: (value: RewardResponse) => Buffer.from(RewardResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => RewardResponse.decode(value),
  },
} as const;

export interface ScoreServiceServer extends UntypedServiceImplementation {
  /** ValidateUploadScoreAndSign validate the upload score and then return signatrue if valid */
  validateUploadScoreAndSign: handleUnaryCall<ValidateUploadScoreAndSignRequest, ValidateUploadScoreAndSignResponse>;
  /** CreateScore create Score with Score */
  createScore: handleUnaryCall<CreateScoreRequest, Score>;
  /** GetScore */
  getScore: handleUnaryCall<GetScoreRequest, Score>;
  /** GetUserBestScoreRanking */
  getUserBestScoreRanking: handleUnaryCall<GetUserBestScoreRankingRequest, UserBestScoreRanking>;
  /** ListUserBestScoreRankings */
  listUserBestScoreRankings: handleUnaryCall<ListUserBestScoreRankingsRequest, ListUserBestScoreRankingsResponse>;
  /** GetUserCumulativeScoreRanking */
  getUserCumulativeScoreRanking: handleUnaryCall<GetUserCumulativeScoreRankingRequest, UserCumulativeScoreRanking>;
  /** ListUserCumulativeScoreRankings */
  listUserCumulativeScoreRankings: handleUnaryCall<
    ListUserCumulativeScoreRankingsRequest,
    ListUserCumulativeScoreRankingsResponse
  >;
  /** GetSquareCumulativeScoreRanking */
  getSquareCumulativeScoreRanking: handleUnaryCall<
    GetSquareCumulativeScoreRankingRequest,
    SquareCumulativeScoreRanking
  >;
  /** ListSquareCumulativeScoreRankings */
  listSquareCumulativeScoreRankings: handleUnaryCall<
    ListSquareCumulativeScoreRankingsRequest,
    ListSquareCumulativeScoreRankingsResponse
  >;
  /** InvalidateScoreRankingsByUser */
  invalidateScoreRankingsByUser: handleUnaryCall<InvalidateScoreRankingsByUserRequest, Empty>;
  /**
   * DryRunReward
   * for admin.
   */
  dryRunReward: handleUnaryCall<RewardRequest, RewardResponse>;
}

export interface ScoreServiceClient extends Client {
  /** ValidateUploadScoreAndSign validate the upload score and then return signatrue if valid */
  validateUploadScoreAndSign(
    request: ValidateUploadScoreAndSignRequest,
    callback: (error: ServiceError | null, response: ValidateUploadScoreAndSignResponse) => void,
  ): ClientUnaryCall;
  validateUploadScoreAndSign(
    request: ValidateUploadScoreAndSignRequest,
    metadata: Metadata,
  ...
  createScore(
    ...
    callback: (error: ServiceError | null, response: Score) => void,
  ): ClientUnaryCall;
  createScore(
    request: CreateScoreRequest,
    metadata: Metadata,
  ...
  /** GetScore */
  getScore(request: GetScoreRequest, callback: (error: ServiceError | null, response: Score) => void): ClientUnaryCall;
  getScore(
  ...
  /** GetUserBestScoreRanking */
  getUserBestScoreRanking(
    request: GetUserBestScoreRankingRequest,
    callback: (error: ServiceError | null, response: UserBestScoreRanking) => void,
  ): ClientUnaryCall;
  getUserBestScoreRanking(
    request: GetUserBestScoreRankingRequest,
    metadata: Metadata,
  ...
  /** ListUserBestScoreRankings */
  listUserBestScoreRankings(
    request: ListUserBestScoreRankingsRequest,
    callback: (error: ServiceError | null, response: ListUserBestScoreRankingsResponse) => void,
  ): ClientUnaryCall;
  listUserBestScoreRankings(
    request: ListUserBestScoreRankingsRequest,
    metadata: Metadata,
  ...
  /** GetUserCumulativeScoreRanking */
  getUserCumulativeScoreRanking(
    request: GetUserCumulativeScoreRankingRequest,
    callback: (error: ServiceError | null, response: UserCumulativeScoreRanking) => void,
  ): ClientUnaryCall;
  getUserCumulativeScoreRanking(
    request: GetUserCumulativeScoreRankingRequest,
    metadata: Metadata,
  ...
  listUserCumulativeScoreRankings(
    ...
    callback: (error: ServiceError | null, response: ListUserCumulativeScoreRankingsResponse) => void,
  ): ClientUnaryCall;
  listUserCumulativeScoreRankings(
    request: ListUserCumulativeScoreRankingsRequest,
    metadata: Metadata,
  ...
  getSquareCumulativeScoreRanking(
    ...
    callback: (error: ServiceError | null, response: SquareCumulativeScoreRanking) => void,
  ): ClientUnaryCall;
  getSquareCumulativeScoreRanking(
    request: GetSquareCumulativeScoreRankingRequest,
    metadata: Metadata,
  ...
  listSquareCumulativeScoreRankings(
    ...
    callback: (error: ServiceError | null, response: ListSquareCumulativeScoreRankingsResponse) => void,
  ): ClientUnaryCall;
  listSquareCumulativeScoreRankings(
    request: ListSquareCumulativeScoreRankingsRequest,
    metadata: Metadata,
  ...
  /** InvalidateScoreRankingsByUser */
  invalidateScoreRankingsByUser(
    request: InvalidateScoreRankingsByUserRequest,
  ...
  dryRunReward(
    ...
    callback: (error: ServiceError | null, response: RewardResponse) => void,
  ): ClientUnaryCall;
  dryRunReward(
    request: RewardRequest,
    metadata: Metadata,
