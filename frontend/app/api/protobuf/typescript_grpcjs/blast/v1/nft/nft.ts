...
export const NFTServiceService = {
  ...
  getNft: {
    path: "/blast.v1.nft.NFTService/GetNFT",
    requestStream: false,
  ...
  listNfTs: {
    path: "/blast.v1.nft.NFTService/ListNFTs",
    requestStream: false,
    responseStream: false,
  ...
  listOwners: {
    path: "/blast.v1.nft.NFTService/ListOwners",
    requestStream: false,
    responseStream: false,
  ...
  validateNftAccess: {
    path: "/blast.v1.nft.NFTService/ValidateNFTAccess",
    requestStream: false,
    responseStream: false,
  ...
  listNfTsDelegate: {
    path: "/blast.v1.nft.NFTService/ListNFTsDelegate",
    requestStream: false,
    responseStream: false,
  ...
  validateNft: {
    path: "/blast.v1.nft.NFTService/ValidateNFT",
    requestStream: false,
    responseStream: false,
  ...
  getContract: {
    path: "/blast.v1.nft.NFTService/GetContract",
    requestStream: false,
    responseStream: false,
  ...
  checkHolderOfContract: {
    path: "/blast.v1.nft.NFTService/CheckHolderOfContract",
    requestStream: false,
    responseStream: false,
