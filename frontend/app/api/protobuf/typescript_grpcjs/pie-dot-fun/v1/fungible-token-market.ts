...
import { Currency, currencyFromJSON, currencyToJSON, currencyToNumber, Money, PriceChangesByPeriod } from "./common";
...
export const FungibleTokenMarket: MessageFns<FungibleTokenMarket> = {
  encode(message: FungibleTokenMarket, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.name !== "") {
    ...
    if (message.nativeCurrency !== Currency.CURRENCY_UNSPECIFIED) {
      writer.uint32(40).int32(currencyToNumber(message.nativeCurrency));
    }
    Object.entries(message.prices).forEach(([key, value]) => {
      FungibleTokenMarket_PricesEntry.encode({ key: key as any, value }, writer.uint32(58).fork()).join();
    });
    Object.entries(message.marketCaps).forEach(([key, value]) => {
      FungibleTokenMarket_MarketCapsEntry.encode({ key: key as any, value }, writer.uint32(66).fork()).join();
    });
    Object.entries(message.priceChanges).forEach(([key, value]) => {
      FungibleTokenMarket_PriceChangesEntry.encode({ key: key as any, value }, writer.uint32(74).fork()).join();
    });
    if (message.price !== undefined) {
      Money.encode(message.price, writer.uint32(82).fork()).join();
    }
    if (message.marketCap !== undefined) {
      Money.encode(message.marketCap, writer.uint32(90).fork()).join();
    }
    if (message.priceChange !== undefined) {
      PriceChangesByPeriod.encode(message.priceChange, writer.uint32(98).fork()).join();
    }
    Object.entries(message.fdvs).forEach(([key, value]) => {
      FungibleTokenMarket_FdvsEntry.encode({ key: key as any, value }, writer.uint32(106).fork()).join();
    });
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): FungibleTokenMarket {
...
export const FungibleTokenMarket_PricesEntry: MessageFns<FungibleTokenMarket_PricesEntry> = {
  encode(message: FungibleTokenMarket_PricesEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): FungibleTokenMarket_PricesEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const FungibleTokenMarket_MarketCapsEntry: MessageFns<FungibleTokenMarket_MarketCapsEntry> = {
  encode(message: FungibleTokenMarket_MarketCapsEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
    if (message.value !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): FungibleTokenMarket_MarketCapsEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const FungibleTokenMarket_PriceChangesEntry: MessageFns<FungibleTokenMarket_PriceChangesEntry> = {
  encode(message: FungibleTokenMarket_PriceChangesEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
    if (message.value !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): FungibleTokenMarket_PriceChangesEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const FungibleTokenMarket_FdvsEntry: MessageFns<FungibleTokenMarket_FdvsEntry> = {
  encode(message: FungibleTokenMarket_FdvsEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
    if (message.value !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): FungibleTokenMarket_FdvsEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
function createBaseGetFungibleTokenMarketRequest(): GetFungibleTokenMarketRequest {
  return { fungibleTokenMarket: "", currency: Currency.CURRENCY_UNSPECIFIED };
}

export const GetFungibleTokenMarketRequest: MessageFns<GetFungibleTokenMarketRequest> = {
  encode(message: GetFungibleTokenMarketRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetFungibleTokenMarketRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListFungibleTokensMarketsRequest: MessageFns<ListFungibleTokensMarketsRequest> = {
  encode(message: ListFungibleTokensMarketsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ListFungibleTokensMarketsRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListFungibleTokensMarketsResponse: MessageFns<ListFungibleTokensMarketsResponse> = {
  encode(message: ListFungibleTokensMarketsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.fungibleTokenMarkets) {
      FungibleTokenMarket.encode(v!, writer.uint32(10).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ListFungibleTokensMarketsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export type FungibleTokenMarketServiceService = typeof FungibleTokenMarketServiceService;
export const FungibleTokenMarketServiceService = {
  /** GetFungibleTokenMarket returns the market for the given fungible token. */
  getFungibleTokenMarket: {
    path: "/piedotfun.v1.FungibleTokenMarketService/GetFungibleTokenMarket",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: GetFungibleTokenMarketRequest) =>
      Buffer.from(GetFungibleTokenMarketRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => GetFungibleTokenMarketRequest.decode(value),
    responseSerialize: (value: FungibleTokenMarket) => Buffer.from(FungibleTokenMarket.encode(value).finish()),
    responseDeserialize: (value: Buffer) => FungibleTokenMarket.decode(value),
  },
  getOrCreateFungibleTokenMarket: {
    path: "/piedotfun.v1.FungibleTokenMarketService/GetOrCreateFungibleTokenMarket",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: GetFungibleTokenMarketRequest) =>
      Buffer.from(GetFungibleTokenMarketRequest.encode(value).finish()),
  ...
  listFungibleTokenMarkets: {
    path: "/piedotfun.v1.FungibleTokenMarketService/ListFungibleTokenMarkets",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: ListFungibleTokensMarketsRequest) =>
      Buffer.from(ListFungibleTokensMarketsRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => ListFungibleTokensMarketsRequest.decode(value),
    responseSerialize: (value: ListFungibleTokensMarketsResponse) =>
      Buffer.from(ListFungibleTokensMarketsResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => ListFungibleTokensMarketsResponse.decode(value),
  },
} as const;

export interface FungibleTokenMarketServiceServer extends UntypedServiceImplementation {
  /** GetFungibleTokenMarket returns the market for the given fungible token. */
  getFungibleTokenMarket: handleUnaryCall<GetFungibleTokenMarketRequest, FungibleTokenMarket>;
  getOrCreateFungibleTokenMarket: handleUnaryCall<GetFungibleTokenMarketRequest, FungibleTokenMarket>;
  /** ListFungibleTokenMarkets returns the list of markets for the given fungible tokens. */
  listFungibleTokenMarkets: handleUnaryCall<ListFungibleTokensMarketsRequest, ListFungibleTokensMarketsResponse>;
}

export interface FungibleTokenMarketServiceClient extends Client {
  /** GetFungibleTokenMarket returns the market for the given fungible token. */
  getFungibleTokenMarket(
    request: GetFungibleTokenMarketRequest,
    callback: (error: ServiceError | null, response: FungibleTokenMarket) => void,
  ): ClientUnaryCall;
  getFungibleTokenMarket(
    request: GetFungibleTokenMarketRequest,
    metadata: Metadata1,
  ...
  /** ListFungibleTokenMarkets returns the list of markets for the given fungible tokens. */
  listFungibleTokenMarkets(
    request: ListFungibleTokensMarketsRequest,
    callback: (error: ServiceError | null, response: ListFungibleTokensMarketsResponse) => void,
  ): ClientUnaryCall;
  listFungibleTokenMarkets(
    request: ListFungibleTokensMarketsRequest,
    metadata: Metadata1,
...
export const FungibleTokenMarketServiceClient = makeGenericClientConstructor(
  FungibleTokenMarketServiceService,
  ...
  ): FungibleTokenMarketServiceClient;
  service: typeof FungibleTokenMarketServiceService;
  serviceName: string;
};
