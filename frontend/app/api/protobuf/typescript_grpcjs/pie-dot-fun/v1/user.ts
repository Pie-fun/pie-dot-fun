...
export const User: MessageFns<User> = {
  encode(message: User, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.wallets) {
      UserWallet.encode(v!, writer.uint32(26).fork()).join();
    }
    ...
    for (const v of message.sns) {
      SNS.encode(v!, writer.uint32(74).fork()).join();
    }
...
export const UserWallet: MessageFns<UserWallet> = {
  encode(message: UserWallet, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): UserWallet {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const UserServiceService = {
  ...
  getUser: {
    path: "/piedotfun.v1.UserService/GetUser",
    requestStream: false,
  ...
  /** ListUsers */
  listUsers: {
    path: "/piedotfun.v1.UserService/ListUsers",
    requestStream: false,
    responseStream: false,
  ...
  updateUser: {
    path: "/piedotfun.v1.UserService/UpdateUser",
    requestStream: false,
    responseStream: false,
  ...
  validateNicknameAvailability: {
    path: "/piedotfun.v1.UserService/ValidateNicknameAvailability",
    requestStream: false,
    responseStream: false,
