...
export const QueryFungibleTokenDecimalsRequest: MessageFns<QueryFungibleTokenDecimalsRequest> = {
  encode(message: QueryFungibleTokenDecimalsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryFungibleTokenDecimalsRequest {
...
export const QueryFungibleTokenDecimalsResponse: MessageFns<QueryFungibleTokenDecimalsResponse> = {
  encode(message: QueryFungibleTokenDecimalsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryFungibleTokenDecimalsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryFungibleTokenMetadataRequest: MessageFns<QueryFungibleTokenMetadataRequest> = {
  encode(message: QueryFungibleTokenMetadataRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.fungibleToken !== "") {
      writer.uint32(10).string(message.fungibleToken);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryFungibleTokenMetadataRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryFungibleTokenMetadataResponse: MessageFns<QueryFungibleTokenMetadataResponse> = {
  encode(message: QueryFungibleTokenMetadataResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.uri !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryFungibleTokenMetadataResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ChainQueryServiceService = {
  queryFungibleTokenDecimals: {
    path: "/piedotfun.v1.chain.ChainQueryService/QueryFungibleTokenDecimals",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: QueryFungibleTokenDecimalsRequest) =>
      Buffer.from(QueryFungibleTokenDecimalsRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => QueryFungibleTokenDecimalsRequest.decode(value),
    responseSerialize: (value: QueryFungibleTokenDecimalsResponse) =>
      Buffer.from(QueryFungibleTokenDecimalsResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => QueryFungibleTokenDecimalsResponse.decode(value),
  },
  queryFungibleTokenMetadata: {
    path: "/piedotfun.v1.chain.ChainQueryService/QueryFungibleTokenMetadata",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: QueryFungibleTokenMetadataRequest) =>
      Buffer.from(QueryFungibleTokenMetadataRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => QueryFungibleTokenMetadataRequest.decode(value),
    responseSerialize: (value: QueryFungibleTokenMetadataResponse) =>
      Buffer.from(QueryFungibleTokenMetadataResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => QueryFungibleTokenMetadataResponse.decode(value),
  },
} as const;

export interface ChainQueryServiceServer extends UntypedServiceImplementation {
  queryFungibleTokenDecimals: handleUnaryCall<QueryFungibleTokenDecimalsRequest, QueryFungibleTokenDecimalsResponse>;
  queryFungibleTokenMetadata: handleUnaryCall<QueryFungibleTokenMetadataRequest, QueryFungibleTokenMetadataResponse>;
}

export interface ChainQueryServiceClient extends Client {
  queryFungibleTokenDecimals(
    request: QueryFungibleTokenDecimalsRequest,
    callback: (error: ServiceError | null, response: QueryFungibleTokenDecimalsResponse) => void,
  ): ClientUnaryCall;
  queryFungibleTokenDecimals(
    request: QueryFungibleTokenDecimalsRequest,
    metadata: Metadata1,
  ...
  queryFungibleTokenMetadata(
    request: QueryFungibleTokenMetadataRequest,
    callback: (error: ServiceError | null, response: QueryFungibleTokenMetadataResponse) => void,
  ): ClientUnaryCall;
  queryFungibleTokenMetadata(
    request: QueryFungibleTokenMetadataRequest,
    metadata: Metadata1,
