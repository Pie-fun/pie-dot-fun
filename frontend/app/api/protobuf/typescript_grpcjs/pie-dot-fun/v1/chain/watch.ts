...
export function basketEventExtraInfoKeyToNumber(object: BasketEventExtraInfoKey): number {
  switch (object) {
    case BasketEventExtraInfoKey.BASKET_EXTRA_INFO_KEY_UNSPECIFIED:
      return 0;
    case BasketEventExtraInfoKey.BASKET_EXTRA_INFO_KEY_VALUE_USDC:
...
export const CreateBasketEvent: MessageFns<CreateBasketEvent> = {
  encode(message: CreateBasketEvent, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CreateBasketEvent {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const StartRebalancingEvent: MessageFns<StartRebalancingEvent> = {
  encode(message: StartRebalancingEvent, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.basketId !== 0) {
      writer.uint32(8).uint64(message.basketId);
    }
    if (message.mint !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): StartRebalancingEvent {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const StopRebalancingEvent: MessageFns<StopRebalancingEvent> = {
  encode(message: StopRebalancingEvent, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.basketId !== 0) {
      writer.uint32(8).uint64(message.basketId);
    }
    if (message.mint !== "") {
    ...
    for (const v of message.components) {
      BasketComponent.encode(v!, writer.uint32(26).fork()).join();
    }
    if (message.timestamp !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): StopRebalancingEvent {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const RedeemBasketTokenEvent: MessageFns<RedeemBasketTokenEvent> = {
  encode(message: RedeemBasketTokenEvent, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.basketId !== 0) {
      writer.uint32(8).uint64(message.basketId);
    }
    if (message.user !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RedeemBasketTokenEvent {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MintBasketTokenEvent: MessageFns<MintBasketTokenEvent> = {
  encode(message: MintBasketTokenEvent, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.basketId !== 0) {
      writer.uint32(8).uint64(message.basketId);
    }
    if (message.user !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MintBasketTokenEvent {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const TransferBasketEvent: MessageFns<TransferBasketEvent> = {
  encode(message: TransferBasketEvent, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.basketMint !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): TransferBasketEvent {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
