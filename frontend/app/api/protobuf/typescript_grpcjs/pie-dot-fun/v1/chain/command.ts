...
export const RebalanceCommand: MessageFns<RebalanceCommand> = {
  encode(message: RebalanceCommand, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    switch (message.strategy?.$case) {
      case "equalWeight":
        RebalanceCommand_EqualMarketCapWeight.encode(message.strategy.equalWeight, writer.uint32(10).fork()).join();
        break;
      case "manualWeight":
        RebalanceCommand_ManualMarketCapWeight.encode(message.strategy.manualWeight, writer.uint32(18).fork()).join();
        break;
      case "trade":
        RebalanceCommand_Trade.encode(message.strategy.trade, writer.uint32(26).fork()).join();
        break;
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): RebalanceCommand {
  ...
  fromPartial<I extends Exact<DeepPartial<RebalanceCommand>, I>>(object: I): RebalanceCommand {
    ...
    switch (object.strategy?.$case) {
      case "equalWeight": {
        if (object.strategy?.equalWeight !== undefined && object.strategy?.equalWeight !== null) {
          message.strategy = {
            $case: "equalWeight",
      ...
      case "manualWeight": {
        if (object.strategy?.manualWeight !== undefined && object.strategy?.manualWeight !== null) {
          message.strategy = {
            $case: "manualWeight",
      ...
      case "trade": {
        if (object.strategy?.trade !== undefined && object.strategy?.trade !== null) {
...
export const RebalanceCommand_EqualMarketCapWeight: MessageFns<RebalanceCommand_EqualMarketCapWeight> = {
  encode(_: RebalanceCommand_EqualMarketCapWeight, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): RebalanceCommand_EqualMarketCapWeight {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const RebalanceCommand_ManualMarketCapWeight: MessageFns<RebalanceCommand_ManualMarketCapWeight> = {
  encode(message: RebalanceCommand_ManualMarketCapWeight, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.requests) {
      RebalanceCommand_ManualMarketCapWeight_Request.encode(v!, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): RebalanceCommand_ManualMarketCapWeight {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const RebalanceCommand_ManualMarketCapWeight_Request: MessageFns<
...
> = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RebalanceCommand_ManualMarketCapWeight_Request {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const RebalanceCommand_Trade: MessageFns<RebalanceCommand_Trade> = {
  encode(message: RebalanceCommand_Trade, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.requests) {
      RebalanceCommand_Trade_Request.encode(v!, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): RebalanceCommand_Trade {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const RebalanceCommand_Trade_Request: MessageFns<RebalanceCommand_Trade_Request> = {
  encode(message: RebalanceCommand_Trade_Request, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.fungibleToken !== "") {
      writer.uint32(10).string(message.fungibleToken);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RebalanceCommand_Trade_Request {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const RebalanceBasketTokenRequest: MessageFns<RebalanceBasketTokenRequest> = {
  encode(message: RebalanceBasketTokenRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.command !== undefined) {
      RebalanceCommand.encode(message.command, writer.uint32(26).fork()).join();
    }
    if (message.executionOption !== undefined) {
      ExecutionOption.encode(message.executionOption, writer.uint32(34).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): RebalanceBasketTokenRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const RebalanceBasketTokenResponse: MessageFns<RebalanceBasketTokenResponse> = {
  encode(message: RebalanceBasketTokenResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RebalanceBasketTokenResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ExecutionOption: MessageFns<ExecutionOption> = {
  encode(message: ExecutionOption, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ExecutionOption {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ChainCommandServiceService = {
  rebalanceBasketToken: {
    path: "/piedotfun.v1.chain.ChainCommandService/RebalanceBasketToken",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: RebalanceBasketTokenRequest) =>
      Buffer.from(RebalanceBasketTokenRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => RebalanceBasketTokenRequest.decode(value),
    responseSerialize: (value: RebalanceBasketTokenResponse) =>
      Buffer.from(RebalanceBasketTokenResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => RebalanceBasketTokenResponse.decode(value),
  },
} as const;

export interface ChainCommandServiceServer extends UntypedServiceImplementation {
  rebalanceBasketToken: handleUnaryCall<RebalanceBasketTokenRequest, RebalanceBasketTokenResponse>;
}

export interface ChainCommandServiceClient extends Client {
  rebalanceBasketToken(
    request: RebalanceBasketTokenRequest,
    callback: (error: ServiceError | null, response: RebalanceBasketTokenResponse) => void,
  ): ClientUnaryCall;
  rebalanceBasketToken(
    request: RebalanceBasketTokenRequest,
    metadata: Metadata,
