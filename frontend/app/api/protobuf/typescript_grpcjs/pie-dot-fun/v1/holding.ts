...
function createBaseGetHoldingRequest(): GetHoldingRequest {
  return { holding: "", currency: Currency.CURRENCY_UNSPECIFIED };
}
...
export const GetHoldingsStatisticsRequest: MessageFns<GetHoldingsStatisticsRequest> = {
  encode(message: GetHoldingsStatisticsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.filter !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetHoldingsStatisticsRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetHoldingsStatisticsResponse: MessageFns<GetHoldingsStatisticsResponse> = {
  encode(message: GetHoldingsStatisticsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.count !== 0) {
      writer.uint32(8).int32(message.count);
    }
    for (const v of message.totalMarketValues) {
      Money.encode(v!, writer.uint32(18).fork()).join();
    }
    for (const v of message.totalPnls) {
      PnL.encode(v!, writer.uint32(26).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): GetHoldingsStatisticsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Holding: MessageFns<Holding> = {
  encode(message: Holding, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.quantity !== undefined) {
      Quantity.encode(message.quantity, writer.uint32(42).fork()).join();
    }
    Object.entries(message.averageBuyPrices).forEach(([key, value]) => {
      Holding_AverageBuyPricesEntry.encode({ key: key as any, value }, writer.uint32(50).fork()).join();
    });
    Object.entries(message.marketValues).forEach(([key, value]) => {
      Holding_MarketValuesEntry.encode({ key: key as any, value }, writer.uint32(58).fork()).join();
    });
    Object.entries(message.pnls).forEach(([key, value]) => {
      Holding_PnlsEntry.encode({ key: key as any, value }, writer.uint32(66).fork()).join();
    });
    if (message.ownershipPercentage !== undefined) {
      Percentage.encode(message.ownershipPercentage, writer.uint32(74).fork()).join();
    }
    ...
    if (message.averageBuyPrice !== undefined) {
      Money.encode(message.averageBuyPrice, writer.uint32(106).fork()).join();
    }
    if (message.marketValue !== undefined) {
      Money.encode(message.marketValue, writer.uint32(114).fork()).join();
    }
    if (message.pnl !== undefined) {
      PnLsByPeriod.encode(message.pnl, writer.uint32(122).fork()).join();
    }
    return writer;
  },
...
export const Holding_AverageBuyPricesEntry: MessageFns<Holding_AverageBuyPricesEntry> = {
  encode(message: Holding_AverageBuyPricesEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Holding_AverageBuyPricesEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Holding_MarketValuesEntry: MessageFns<Holding_MarketValuesEntry> = {
  encode(message: Holding_MarketValuesEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
    if (message.value !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Holding_MarketValuesEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Holding_PnlsEntry: MessageFns<Holding_PnlsEntry> = {
  encode(message: Holding_PnlsEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
    if (message.value !== undefined) {
      PnLsByPeriod.encode(message.value, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Holding_PnlsEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export type HoldingServiceService = typeof HoldingServiceService;
export const HoldingServiceService = {
  getHolding: {
    path: "/piedotfun.v1.HoldingService/GetHolding",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: GetHoldingRequest) => Buffer.from(GetHoldingRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => GetHoldingRequest.decode(value),
    responseSerialize: (value: Holding) => Buffer.from(Holding.encode(value).finish()),
    responseDeserialize: (value: Buffer) => Holding.decode(value),
  },
  listHoldings: {
    path: "/piedotfun.v1.HoldingService/ListHoldings",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: ListHoldingsRequest) => Buffer.from(ListHoldingsRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => ListHoldingsRequest.decode(value),
    responseSerialize: (value: ListHoldingsResponse) => Buffer.from(ListHoldingsResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => ListHoldingsResponse.decode(value),
  },
  ...
  getHoldingsStatistics: {
    path: "/piedotfun.v1.HoldingService/GetHoldingsStatistics",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: GetHoldingsStatisticsRequest) =>
      Buffer.from(GetHoldingsStatisticsRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => GetHoldingsStatisticsRequest.decode(value),
    responseSerialize: (value: GetHoldingsStatisticsResponse) =>
      Buffer.from(GetHoldingsStatisticsResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => GetHoldingsStatisticsResponse.decode(value),
  },
} as const;

export interface HoldingServiceServer extends UntypedServiceImplementation {
  getHolding: handleUnaryCall<GetHoldingRequest, Holding>;
  listHoldings: handleUnaryCall<ListHoldingsRequest, ListHoldingsResponse>;
  /** GetHoldingsStatistics ListHoldings 와 같은 필터를 기준으로 Total Count, Total Market Value in USDC, Total Market Value in SOL 을 반환합니다. */
  getHoldingsStatistics: handleUnaryCall<GetHoldingsStatisticsRequest, GetHoldingsStatisticsResponse>;
}

export interface HoldingServiceClient extends Client {
  getHolding(
    request: GetHoldingRequest,
    callback: (error: ServiceError | null, response: Holding) => void,
  ): ClientUnaryCall;
  getHolding(
    request: GetHoldingRequest,
    metadata: Metadata1,
  ...
  listHoldings(
    ...
    callback: (error: ServiceError | null, response: ListHoldingsResponse) => void,
  ): ClientUnaryCall;
  listHoldings(
    request: ListHoldingsRequest,
    metadata: Metadata1,
  ...
  /** GetHoldingsStatistics ListHoldings 와 같은 필터를 기준으로 Total Count, Total Market Value in USDC, Total Market Value in SOL 을 반환합니다. */
  getHoldingsStatistics(
    request: GetHoldingsStatisticsRequest,
    callback: (error: ServiceError | null, response: GetHoldingsStatisticsResponse) => void,
  ): ClientUnaryCall;
  getHoldingsStatistics(
    request: GetHoldingsStatisticsRequest,
    metadata: Metadata1,
...
export const HoldingServiceClient = makeGenericClientConstructor(
  HoldingServiceService,
  "piedotfun.v1.HoldingService",
) as unknown as {
  new (address: string, credentials: ChannelCredentials, options?: Partial<ClientOptions>): HoldingServiceClient;
  service: typeof HoldingServiceService;
  serviceName: string;
};
