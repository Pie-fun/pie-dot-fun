...
export const GetBasketTokenRequest: MessageFns<GetBasketTokenRequest> = {
  encode(message: GetBasketTokenRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetBasketTokenRequest {
...
export const ListBasketTokensRequest: MessageFns<ListBasketTokensRequest> = {
  encode(message: ListBasketTokensRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ListBasketTokensRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListBasketTokensResponse: MessageFns<ListBasketTokensResponse> = {
  encode(message: ListBasketTokensResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.basketTokens) {
      BasketToken.encode(v!, writer.uint32(10).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ListBasketTokensResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListRebalancingHistoriesRequest: MessageFns<ListRebalancingHistoriesRequest> = {
  encode(message: ListRebalancingHistoriesRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.basketToken !== "") {
      writer.uint32(10).string(message.basketToken);
    }
    if (message.pageSize !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ListRebalancingHistoriesRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListRebalancingHistoriesResponse: MessageFns<ListRebalancingHistoriesResponse> = {
  encode(message: ListRebalancingHistoriesResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.rebalancingHistories) {
      BasketTokenRebanlancingHistory.encode(v!, writer.uint32(10).fork()).join();
    }
    if (message.nextPageToken !== "") {
      writer.uint32(18).string(message.nextPageToken);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ListRebalancingHistoriesResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const BasketToken: MessageFns<BasketToken> = {
  encode(message: BasketToken, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.name !== "") {
    ...
    for (const v of message.components) {
      Component.encode(v!, writer.uint32(122).fork()).join();
    }
    if (message.creator !== "") {
    ...
    if (message.expireTime !== undefined) {
      Timestamp.encode(toTimestamp(message.expireTime), writer.uint32(146).fork()).join();
    }
    if (message.lastRebalanceTime !== undefined) {
      Timestamp.encode(toTimestamp(message.lastRebalanceTime), writer.uint32(154).fork()).join();
    }
    if (message.totalSupply !== undefined) {
      Quantity.encode(message.totalSupply, writer.uint32(162).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): BasketToken {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 21: {
          ...
          message.totalHolders = longToNumber(reader.uint64());
          continue;
        }
        case 22: {
          if (tag !== 178) {
...
export const Component: MessageFns<Component> = {
  encode(message: Component, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.weight !== undefined) {
      Percentage.encode(message.weight, writer.uint32(34).fork()).join();
    }
    return writer;
  },
...
export const BasketTokenRebanlancingHistory: MessageFns<BasketTokenRebanlancingHistory> = {
  encode(message: BasketTokenRebanlancingHistory, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.rebalanceTime !== undefined) {
      Timestamp.encode(toTimestamp(message.rebalanceTime), writer.uint32(34).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): BasketTokenRebanlancingHistory {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export type BasketTokenServiceService = typeof BasketTokenServiceService;
export const BasketTokenServiceService = {
  getBasketToken: {
    path: "/piedotfun.v1.BasketTokenService/GetBasketToken",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: GetBasketTokenRequest) => Buffer.from(GetBasketTokenRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => GetBasketTokenRequest.decode(value),
    responseSerialize: (value: BasketToken) => Buffer.from(BasketToken.encode(value).finish()),
    responseDeserialize: (value: Buffer) => BasketToken.decode(value),
  },
  listBasketTokens: {
    path: "/piedotfun.v1.BasketTokenService/ListBasketTokens",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: ListBasketTokensRequest) => Buffer.from(ListBasketTokensRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => ListBasketTokensRequest.decode(value),
    responseSerialize: (value: ListBasketTokensResponse) =>
      Buffer.from(ListBasketTokensResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => ListBasketTokensResponse.decode(value),
  },
  listBasketTokenRebalancingHistories: {
    path: "/piedotfun.v1.BasketTokenService/ListBasketTokenRebalancingHistories",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: ListRebalancingHistoriesRequest) =>
      Buffer.from(ListRebalancingHistoriesRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => ListRebalancingHistoriesRequest.decode(value),
    responseSerialize: (value: ListRebalancingHistoriesResponse) =>
      Buffer.from(ListRebalancingHistoriesResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => ListRebalancingHistoriesResponse.decode(value),
  },
} as const;

export interface BasketTokenServiceServer extends UntypedServiceImplementation {
  getBasketToken: handleUnaryCall<GetBasketTokenRequest, BasketToken>;
  listBasketTokens: handleUnaryCall<ListBasketTokensRequest, ListBasketTokensResponse>;
  listBasketTokenRebalancingHistories: handleUnaryCall<
    ListRebalancingHistoriesRequest,
    ListRebalancingHistoriesResponse
  >;
}

export interface BasketTokenServiceClient extends Client {
  getBasketToken(
    request: GetBasketTokenRequest,
    callback: (error: ServiceError | null, response: BasketToken) => void,
  ): ClientUnaryCall;
  getBasketToken(
    request: GetBasketTokenRequest,
    metadata: Metadata,
  ...
  listBasketTokens(
    ...
    callback: (error: ServiceError | null, response: ListBasketTokensResponse) => void,
  ): ClientUnaryCall;
  listBasketTokens(
    request: ListBasketTokensRequest,
    metadata: Metadata,
  ...
  listBasketTokenRebalancingHistories(
    ...
    callback: (error: ServiceError | null, response: ListRebalancingHistoriesResponse) => void,
  ): ClientUnaryCall;
  listBasketTokenRebalancingHistories(
    request: ListRebalancingHistoriesRequest,
    metadata: Metadata,
...
export const BasketTokenServiceClient = makeGenericClientConstructor(
  BasketTokenServiceService,
  "piedotfun.v1.BasketTokenService",
) as unknown as {
  new (address: string, credentials: ChannelCredentials, options?: Partial<ClientOptions>): BasketTokenServiceClient;
  service: typeof BasketTokenServiceService;
  serviceName: string;
};
