...
function createBaseNotificationContent(): NotificationContent {
  return { icon: NotificationContentIcon.ICON_UNSPECIFIED, title: "", body: "" };
}
...
export const NotificationContent: MessageFns<NotificationContent> = {
  encode(message: NotificationContent, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.icon !== NotificationContentIcon.ICON_UNSPECIFIED) {
      writer.uint32(8).int32(notificationContentIconToNumber(message.icon));
    }
    if (message.title !== "") {
...
export const Notification: MessageFns<Notification> = {
  encode(message: Notification, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.content !== undefined) {
      NotificationContent.encode(message.content, writer.uint32(58).fork()).join();
    }
    ...
    if (message.acknowledgeTime !== undefined) {
      Timestamp.encode(toTimestamp(message.acknowledgeTime), writer.uint32(82).fork()).join();
    }
    Object.entries(message.metadata).forEach(([key, value]) => {
      Notification_MetadataEntry.encode({ key: key as any, value }, writer.uint32(90).fork()).join();
    });
    return writer;
  },
...
export const NotificationServiceService = {
  ...
  listNotifications: {
    path: "/ethereum.v1.notification.NotificationService/ListNotifications",
    requestStream: false,
  ...
  acknowledgeNotification: {
    path: "/ethereum.v1.notification.NotificationService/AcknowledgeNotification",
    requestStream: false,
    responseStream: false,
  ...
  createNotification: {
    path: "/ethereum.v1.notification.NotificationService/CreateNotification",
    requestStream: false,
    responseStream: false,
...
export interface NotificationServiceServer extends UntypedServiceImplementation {
  ...
  /** CreateNotification create Notification with Notification */
  createNotification: handleUnaryCall<CreateNotificationRequest, Notification>;
}
