...
export const ListScoresRequest: MessageFns<ListScoresRequest> = {
  encode(message: ListScoresRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ListScoresRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListScoresResponse: MessageFns<ListScoresResponse> = {
  encode(message: ListScoresResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ListScoresResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ScoreServiceService = {
  ...
  createScore: {
    path: "/ethereum.v1.score.ScoreService/CreateScore",
    requestStream: false,
  ...
  listScores: {
    path: "/ethereum.v1.score.ScoreService/ListScores",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: ListScoresRequest) => Buffer.from(ListScoresRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => ListScoresRequest.decode(value),
    responseSerialize: (value: ListScoresResponse) => Buffer.from(ListScoresResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => ListScoresResponse.decode(value),
  },
  /** GetScore */
  getScore: {
    path: "/ethereum.v1.score.ScoreService/GetScore",
    requestStream: false,
    responseStream: false,
...
export interface ScoreServiceServer extends UntypedServiceImplementation {
  ...
  /** ListScores will return scores. */
  listScores: handleUnaryCall<ListScoresRequest, ListScoresResponse>;
  /** GetScore */
...
export interface ScoreServiceClient extends Client {
  ...
  listScores(
    ...
    callback: (error: ServiceError | null, response: ListScoresResponse) => void,
  ): ClientUnaryCall;
  listScores(
    request: ListScoresRequest,
    metadata: Metadata,
...
export const ScoreServiceClient = makeGenericClientConstructor(
  ScoreServiceService,
  "ethereum.v1.score.ScoreService",
) as unknown as {
