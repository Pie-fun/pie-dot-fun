...
export const MySpace: MessageFns<MySpace> = {
  encode(message: MySpace, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.profile !== "") {
      writer.uint32(10).string(message.profile);
    }
    if (message.assets !== undefined) {
      Assets.encode(message.assets, writer.uint32(18).fork()).join();
    }
    if (message.starDoodles !== undefined) {
      StarDoodles.encode(message.starDoodles, writer.uint32(26).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): MySpace {
...
export const Assets: MessageFns<Assets> = {
  encode(message: Assets, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.spaceships) {
      SpaceshipAsset.encode(v!, writer.uint32(10).fork()).join();
    }
    for (const v of message.badges) {
      BadgeAsset.encode(v!, writer.uint32(18).fork()).join();
    }
    for (const v of message.scores) {
      ScoreAsset.encode(v!, writer.uint32(26).fork()).join();
    }
    for (const v of message.alphabets) {
      AlphabetAsset.encode(v!, writer.uint32(34).fork()).join();
    }
    for (const v of message.blocks) {
      BlockAsset.encode(v!, writer.uint32(42).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Assets {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SpaceshipReference: MessageFns<SpaceshipReference> = {
  encode(message: SpaceshipReference, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.name !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SpaceshipReference {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const BadgeReference: MessageFns<BadgeReference> = {
  encode(message: BadgeReference, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.name !== "") {
      writer.uint32(10).string(message.name);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): BadgeReference {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ScoreReference: MessageFns<ScoreReference> = {
  encode(message: ScoreReference, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.name !== "") {
      writer.uint32(10).string(message.name);
    }
    if (message.tokenId !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ScoreReference {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SpaceshipAsset: MessageFns<SpaceshipAsset> = {
  encode(message: SpaceshipAsset, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== 0) {
    ...
    if (message.reference !== undefined) {
      SpaceshipReference.encode(message.reference, writer.uint32(50).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): SpaceshipAsset {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const BadgeAsset: MessageFns<BadgeAsset> = {
  encode(message: BadgeAsset, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== 0) {
      writer.uint32(8).uint64(message.id);
    }
    if (message.imageUri !== "") {
    ...
    if (message.reference !== undefined) {
      BadgeReference.encode(message.reference, writer.uint32(50).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): BadgeAsset {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ScoreAsset: MessageFns<ScoreAsset> = {
  encode(message: ScoreAsset, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== 0) {
      writer.uint32(8).uint64(message.id);
    }
    if (message.imageUri !== "") {
    ...
    if (message.reference !== undefined) {
      ScoreReference.encode(message.reference, writer.uint32(50).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ScoreAsset {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const AlphabetAsset: MessageFns<AlphabetAsset> = {
  encode(message: AlphabetAsset, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== 0) {
      writer.uint32(8).uint64(message.id);
    }
    if (message.imageUri !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): AlphabetAsset {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const BlockAsset: MessageFns<BlockAsset> = {
  encode(message: BlockAsset, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== 0) {
      writer.uint32(8).uint64(message.id);
    }
    if (message.imageUri !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): BlockAsset {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const StarDoodles: MessageFns<StarDoodles> = {
  encode(message: StarDoodles, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.imageUri !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): StarDoodles {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
