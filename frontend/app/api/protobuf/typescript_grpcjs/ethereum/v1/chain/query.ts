...
export const ChainQueryServiceService = {
  queryReceipt: {
    path: "/ethereum.v1.chain.ChainQueryService/QueryReceipt",
    requestStream: false,
  ...
  queryTransactionCount: {
    path: "/ethereum.v1.chain.ChainQueryService/QueryTransactionCount",
    requestStream: false,
    responseStream: false,
  ...
  queryDelegateCash: {
    path: "/ethereum.v1.chain.ChainQueryService/QueryDelegateCash",
    requestStream: false,
    responseStream: false,
