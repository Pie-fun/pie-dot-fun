...
export function primaryTypeToNumber(object: PrimaryType): number {
  switch (object) {
    case PrimaryType.PRIMARY_TYPE_UNSPECIFIED:
      return 0;
    case PrimaryType.W_KEY:
...
export function secondaryTypeToNumber(object: SecondaryType): number {
  switch (object) {
    case SecondaryType.SECONDARY_TYPE_UNSPECIFIED:
      return 0;
    case SecondaryType.TIER_1:
...
export const ListKeyVOsRequest: MessageFns<ListKeyVOsRequest> = {
  encode(message: ListKeyVOsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.filter !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ListKeyVOsRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListKeyVOsResponse: MessageFns<ListKeyVOsResponse> = {
  encode(message: ListKeyVOsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.keyValueObjects) {
      KeyVO.encode(v!, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ListKeyVOsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CreateKeyVORequest: MessageFns<CreateKeyVORequest> = {
  encode(message: CreateKeyVORequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.keyVo !== undefined) {
      KeyVO.encode(message.keyVo, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CreateKeyVORequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Key: MessageFns<Key> = {
  encode(message: Key, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.mintTime !== undefined) {
      Timestamp.encode(toTimestamp(message.mintTime), writer.uint32(50).fork()).join();
    }
    ...
    if (message.vo !== undefined) {
      KeyVO.encode(message.vo, writer.uint32(82).fork()).join();
    }
    return writer;
  },
...
function createBaseKeyVO(): KeyVO {
  return {
    address: "",
    tokenId: "",
    primaryType: PrimaryType.PRIMARY_TYPE_UNSPECIFIED,
    secondaryType: SecondaryType.SECONDARY_TYPE_UNSPECIFIED,
    cachedImageUri: "",
    originalImageUri: "",
    metadataUri: "",
    contractAddress: "",
...
export const KeyVO: MessageFns<KeyVO> = {
  encode(message: KeyVO, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.address !== "") {
    ...
    if (message.primaryType !== PrimaryType.PRIMARY_TYPE_UNSPECIFIED) {
      writer.uint32(24).int32(primaryTypeToNumber(message.primaryType));
    }
    if (message.secondaryType !== SecondaryType.SECONDARY_TYPE_UNSPECIFIED) {
      writer.uint32(32).int32(secondaryTypeToNumber(message.secondaryType));
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): KeyVO {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3: {
          ...
          message.primaryType = primaryTypeFromJSON(reader.int32());
          continue;
        }
        case 4: {
          if (tag !== 32) {
          ...
          message.secondaryType = secondaryTypeFromJSON(reader.int32());
          continue;
        }
        case 5: {
          if (tag !== 42) {
  ...
  fromJSON(object: any): KeyVO {
    return {
      ...
      primaryType: isSet(object.primaryType)
        ? primaryTypeFromJSON(object.primaryType)
        : PrimaryType.PRIMARY_TYPE_UNSPECIFIED,
      secondaryType: isSet(object.secondaryType)
        ? secondaryTypeFromJSON(object.secondaryType)
        : SecondaryType.SECONDARY_TYPE_UNSPECIFIED,
  ...
  fromPartial<I extends Exact<DeepPartial<KeyVO>, I>>(object: I): KeyVO {
    ...
    message.primaryType = object.primaryType ?? PrimaryType.PRIMARY_TYPE_UNSPECIFIED;
    message.secondaryType = object.secondaryType ?? SecondaryType.SECONDARY_TYPE_UNSPECIFIED;
...
export const KeyServiceService = {
  ...
  listKeys: {
    path: "/ethereum.v1.key.KeyService/ListKeys",
    requestStream: false,
  ...
  listKeyValueObjects: {
    path: "/ethereum.v1.key.KeyService/ListKeyValueObjects",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: ListKeyVOsRequest) => Buffer.from(ListKeyVOsRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => ListKeyVOsRequest.decode(value),
    responseSerialize: (value: ListKeyVOsResponse) => Buffer.from(ListKeyVOsResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => ListKeyVOsResponse.decode(value),
  },
} as const;
...
export interface KeyServiceServer extends UntypedServiceImplementation {
  ...
  /** ListKeyValueObjects will return KeyVOs. */
  listKeyValueObjects: handleUnaryCall<ListKeyVOsRequest, ListKeyVOsResponse>;
}
...
export interface KeyServiceClient extends Client {
  ...
  /** ListKeyValueObjects will return KeyVOs. */
  listKeyValueObjects(
    request: ListKeyVOsRequest,
    callback: (error: ServiceError | null, response: ListKeyVOsResponse) => void,
  ): ClientUnaryCall;
  listKeyValueObjects(
    request: ListKeyVOsRequest,
    metadata: Metadata,
