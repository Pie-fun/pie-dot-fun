...
func RegisterBackspaceServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server BackspaceServiceServer) error {
	...
	mux.Handle("GET", pattern_BackspaceService_GetBackspace_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/blast.v1.user.BackspaceService/GetBackspace", runtime.WithHTTPPathPattern("/v1/{user=users/*}/backspace"))
		if err != nil {
	...
	mux.Handle("PATCH", pattern_BackspaceService_UpdateBackspace_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/blast.v1.user.BackspaceService/UpdateBackspace", runtime.WithHTTPPathPattern("/v1/{backspace.name=users/*/backspace}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterBackspaceServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client BackspaceServiceClient) error {
	...
	mux.Handle("GET", pattern_BackspaceService_GetBackspace_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/blast.v1.user.BackspaceService/GetBackspace", runtime.WithHTTPPathPattern("/v1/{user=users/*}/backspace"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("PATCH", pattern_BackspaceService_UpdateBackspace_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/blast.v1.user.BackspaceService/UpdateBackspace", runtime.WithHTTPPathPattern("/v1/{backspace.name=users/*/backspace}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_BackspaceService_GetBackspace_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 2, 5, 2, 2, 3}, []string{"v1", "users", "user", "backspace"}, ""))

	pattern_BackspaceService_UpdateBackspace_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 2, 2, 4, 3, 5, 3}, []string{"v1", "users", "backspace", "backspace.name"}, ""))
)
