...
func request_GameService_GetDailyPlayCount_0(ctx context.Context, marshaler runtime.Marshaler, client GameServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetDailyPlayCountRequest
	...
	msg, err := client.GetDailyPlayCount(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_GameService_GetDailyPlayCount_0(ctx context.Context, marshaler runtime.Marshaler, server GameServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetDailyPlayCountRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.GetDailyPlayCount(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterGameServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server GameServiceServer) error {
	...
	mux.Handle("GET", pattern_GameService_GetDailyPlayCount_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/blast.v1.game.GameService/GetDailyPlayCount", runtime.WithHTTPPathPattern("/v1/games/{user=users/*}/daily_play_count"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_GameService_GetDailyPlayCount_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		...
		forward_GameService_GetDailyPlayCount_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterGameServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client GameServiceClient) error {
	...
	mux.Handle("GET", pattern_GameService_GetDailyPlayCount_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/blast.v1.game.GameService/GetDailyPlayCount", runtime.WithHTTPPathPattern("/v1/games/{user=users/*}/daily_play_count"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_GameService_GetDailyPlayCount_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_GameService_GetDailyPlayCount_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 2, 5, 3, 2, 4}, []string{"v1", "games", "users", "user", "daily_play_count"}, ""))
)

var (
	forward_GameService_GetDailyPlayCount_0 = runtime.ForwardResponseMessage
)
